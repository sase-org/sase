...
- **What about the sase-google `mentor.md`?** It currently defines the entire mentor persona/workflow. Under the new
  system, the built-in `#mentor` xprompt (tagged `mentor`) replaces it. Does the sase-google plugin need any changes, or
