...
[![Full CI](https://github.com/sase-org/sase/actions/workflows/full.yml/badge.svg?branch=master)](https://github.com/sase-org/sase/actions/workflows/full.yml)
...
<p><small>CI checks pull requests, Master Gate is the per-SHA master release gate, and Full CI runs the scheduled exhaustive lane.</small></p>
...
separate mechanism: it can select Grok through the shipped `@small`, `@medium`,
`@large`, and `@xlarge` pools when Grok Build is installed.
