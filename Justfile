...
_lint-pyvision: _setup
    BD_COMMAND=tools/sase_bead {{ venv_bin }}/python tools/executable_pyvision-260512 src/sase --epic-symbol 'sase-4d(allocate_project_alias)' --epic-symbol 'sase-4d(ensure_project_alias_locked)'
