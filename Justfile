...
# provide the workspace-matched sibling checkout via SASE_SIBLING_REPO_SASE_CORE_DIR.
sase_core_env_default := env_var_or_default("SASE_SIBLING_REPO_SASE_CORE_DIR", env_var_or_default("SASE_SIBLING_REPO_CORE_DIR", "../sase-core"))
sase_core_dir := env_var_or_default("SASE_CORE_DIR", sase_core_env_default)
