...
_lint-symvision *args: _setup
    SASE_SYMVISION_BEAD_STATUS_ONLY=1 BD_COMMAND=tools/sase_bead {{ venv_bin }}/symvision src/sase \
        ...
        --epic-symbol "sase-pw.4(CurrentProject)" \
        --epic-symbol "sase-pw.4(peek_current_project_change_token)" \
        --epic-symbol "sase-pw.4(project_accent)" \
        --epic-symbol "sase-pw.4(project_accent_map)" \
        --epic-symbol "sase-pw.4(resolve_current_project)" \
        {{ args }}
