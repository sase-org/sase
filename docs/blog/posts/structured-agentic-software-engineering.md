...
views for Stitches, Patches, Beads, configured document providers, and Files. Its
Patches view owns durable PR-sized Patch records. Axe is the background daemon view.
