...
# Post 8: Driving SASE From Your Phone — Telegram as the Mobile Control Surface
...
Both scripts shell into the same notification machinery [Post 4](axe-background-daemon.md) covered. The outbound side
...
| ----------------- | ----------------------------------------------------- | ----------------------------------------------------------------------- |
| Plan Approval     | Tale / ✅ Approve / Epic / Legend / Reject / Feedback | The four SDD plan modes from [Post 5](beads-and-sdd.md), plus rejection |
...
and sends the PDF as an attachment. Either way, the four mode buttons map directly to the SDD plan modes from Post 5 —
