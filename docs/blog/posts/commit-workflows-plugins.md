...
# Post 6: Commit Workflows — The Pluggable Path From Diff to PR
...
[Post 5](beads-and-sdd.md) covered how a plan turns into a fleet of phase agents that produce code. This post covers
...
- [Post 7: ChangeSpecs in Practice — Review State Outside the Chat](changespecs-in-practice.md) — what the commit/PR
  flow writes to, and how ACE reviews it.
