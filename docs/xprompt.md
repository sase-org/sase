...
[glossary configuration](configuration.md#glossary). A leading VCS workflow reference
...
context, and go-to-definition targets the glossary entry's `definition` range in the
project-local config. Explicit xprompt and artifact references keep precedence over
