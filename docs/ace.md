...
| `T`                 | Open tmux window in primary workspace                        |
...
| Key | Action                                                        |
| --- | ------------------------------------------------------------- |
| `c` | Commit (dismiss modal and trigger commit action for the plan) |
| `y` | Copy plan content to clipboard                                |
| `Y` | Copy plan file path to clipboard                              |

The `c` keybinding also copies the plan file path to the clipboard before dismissing. The question modal also supports
`y` to copy questions and selected answers.
