...
| `sase glossary show`                         | Print one or more glossary terms plus the recursive closure of terms their definitions depend on.                  | [Glossary](memory.md#glossary)                                    |
| `sase glossary read`                         | Agent-side audited read of one or more glossary terms; requires `-r/--reason`.                                     | [Glossary](memory.md#glossary)                                    |
...
| `sase flag` / `flag list`               | Inspect registered feature flags, resolved values, provenance, flag beads, and removal countdowns; `flag new` scaffolds a flag and its removal bead.                                                                      | [Configuration](configuration.md#feature_flags), [Beads](beads.md#flag-bead-lifecycle)                               |
