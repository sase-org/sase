...
| `sase artifact-file create`         | Move an explicit file into persistent agent artifact storage; agent-only (`SASE_AGENT=1`).                                                                            | [Agent attachments](agent_images.md#explicit-artifact-contract)                                                      |
