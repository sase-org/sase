...
| `sase var show`                     | Show one agent's stored output-variable snapshot: the current run with no name, or the newest visible exact-name artifact.                                                                                                | [XPrompt variables](xprompt.md#cross-agent-output-variables)                                                         |
| `sase var get`                      | Retrieve precise values with exact, global, hood, key-wildcard, and JSON-path selectors.                                                                                                                                  | [XPrompt variables](xprompt.md#cross-agent-output-variables)                                                         |
