...
| `sase init`                                  | Check and initialize memory, SDD, and skills for the current project.                                                                   | [Initialization](init.md)                                             |
...
| `sase memory init`                           | Refresh home and opted-in project memory; copy existing AGENTS.md files to provider instructions.                                       | [Initialization](init.md#memory-initialization)                       |
| `sase init memory`                           | Alias for `sase memory init`.                                                                                                           | [Initialization](init.md#memory-initialization)                       |
| `sase sdd init`                              | Create/connect effective SDD storage and refresh generated guide files.                                                                 | [SDD](sdd.md)                                                         |
