...
| `sase pager [REF\|PATH ...]`    | Read artifact references, file paths, or stdin in the link-traversing SASE pager when `link_pager` is enabled; redirected stdout and `--plain` write plain text.                                                                                                                                                                                                                                                                                                                                                                                                                                     | [SASE Pager](pager.md)                                                   |
