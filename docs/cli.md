...
| `sase init sdd`                              | Compatibility alias for the default SDD init flow; use `sase sdd init` for `--storage`.                                                 | [SDD](sdd.md)                                                         |
| `sase sdd links`                             | Inspect prompt/artifact frontmatter links.                                                                                              | [SDD](sdd.md)                                                         |
| `sase sdd list`                              | List SDD prompt, tale, epic, legend, myth, or all Markdown artifacts.                                                                   | [SDD](sdd.md)                                                         |
| `sase sdd migrate`                           | Move existing in-tree or local SDD files into the provider companion repository used by `sdd.storage=separate_repo`.                    | [SDD Storage](sdd_storage.md#migration-and-offline-behavior)          |
