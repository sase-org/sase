...
| `sase artifact path`                | Print the single absolute filesystem path a filesystem-backed artifact reference resolves to.                                                                                                                          | [Configuration CLI flags](configuration.md#sase-artifact)                                                            |
