...
| `sase telemetry dashboard`    | Open the live local telemetry dashboard.                                                                                                                              | [Telemetry](telemetry.md)                                                                                            |
| `sase telemetry graph`        | Render one metric as a pipeable terminal chart.                                                                                                                       | [Telemetry](telemetry.md)                                                                                            |
