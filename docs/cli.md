...
| `sase bead show`                             | Show one or more issues; `<epic-id>..` expands the epic plus its direct children, and long terminal output pages with color intact.                   | [Beads](beads.md#cli-commands)                                    |
