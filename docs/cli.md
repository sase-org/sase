...
| `sase agent prompts`                | Browse and validate the canonical agents-sidecar prompt archive; `migrate --write` moves historical plans-sidecar prompts into `prompts/<YYYYMM>/`.                                                                                | [Agent Hood Synchronization](agents_sidecar.md#prompt-and-artifact-archive)                                          |
