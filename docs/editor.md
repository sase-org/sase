...
| Hover                 | Shows xprompt metadata, descriptions, previews, source display paths, tags, and active input hints. Memory entries also show their kind and memory type (`core`/`reference`).                                                                                                                                                                                                                                                                          |
