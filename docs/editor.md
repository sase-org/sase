...
| Feature                 | Behavior                                                                                                                                                                                                                                                                                                 |
| ----------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| XPrompt completion      | Completes `#name`, `#!workflow`, namespaced references, and slash-skill references from the structured catalog. Skills complete as `#skills/<name>` after `#` and as `/<name>` after a slash. [Memory notes](xprompt.md#memory-field) complete as `#memory/<stem>` and never appear in slash completion. |
