...
The series has ten posts. Post 0 is the origin story; Posts 1 and 2 set up the _why_ and the _how_; Posts 3–8 each go
deep on one subsystem; Post 9 looks forward. Read in numbered order for the full arc, or jump straight to the subsystem
...
| [Post 9: What's Next — Shared Memory, Mobile, and the Web Surface](../blog/posts/whats-next-memory-mobile-web.md)            | Published 2026-05-22 |
