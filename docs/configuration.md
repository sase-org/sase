...
| `llm_provider.usage_metrics.indicator.enabled`                        | bool   | `true`                          | Show ACE top-bar usage indicators. False hides display entries while collection and Providers · Usage remain active.                              |
