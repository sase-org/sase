...
| SDD artifacts    | Provider-resolved `sdd/`, `.sase/sdd/`, or split sidecar roots     | Plans, executable epics, research notes, and historical/exported prompt snapshots; resolve with `sase repo path plans` or `research`.                                                          |
