...
- `sase-gchat` at `/home/bryan/projects/github/sase-org/sase-gchat`
...
- Google Chat dot commands are parsed in `sase_gchat/inbound.py` and dispatched in
  `sase_gchat/scripts/sase_gc_inbound.py`. Current gchat "copyable" UX is fenced code snippets, not true platform copy
...
**Repos:** `../sase-telegram`, `../sase-gchat`, and only `sase_100` if Phase 1 docs need a follow-up.
