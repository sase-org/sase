...
`research/agent_status_report.md` lays this out explicitly (Idea A, "HIGH ROI, LOW EFFORT"). This plan ships that idea
...
Column rules (from `research/agent_status_report.md` Idea H):
