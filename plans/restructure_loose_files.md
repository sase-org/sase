...
4. **Check plugin repos** (`../sase-github`, `../sase-google`, `../sase-telegram`) for old imports — update if found
...
2. Grep plugin repos (`../sase-github`, `../sase-google`, `../sase-telegram`) for old import paths — update if found
