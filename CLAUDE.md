...
Memory Strand; Memory Web; Nav Item (navigation item); Nav Section (navigation section);
...
Proc; Stitch; Strand Keyword; Task Type (task type); Tool Catalog; Tool Run; Usage
Window (usage-window); Xprompt; Xprompt Memory (memory file, sase memory); Xprompt Part;
