---
plan: sdd/epics/202604/legacy_chat_integration_integration.md
---
 I want to create a new ../legacy-chat-integration repo (I've already created it with an empty README.md file--give that file good contents after this repo is implemented) that provides a chop integration with Google Chat that offers all of
