---
plan: sdd/tales/202604/commit_parent_flag.md
---
...
least its not working for child CLs created by the `#split` xprompt workflow--defined in the ../legacy-mercurial-plugin repo). Can
