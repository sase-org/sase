---
plan: sdd/epics/202604/sase_gchat_integration.md
---
 I want to create a new ../sase-gchat repo (I've already created it with an empty README.md file--give that file good contents after this repo is implemented) that provides a chop integration with Google Chat that offers all of
