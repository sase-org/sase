...
│  │  ▎ sase-24 ────────────────────────────────────────────────  2 agents · 2 running    ││    17 `PLAN COMMITTED`. Those parents are often loaded from a completed planner `done.json`, so they can have a fixed     │
│  │  │  ▸ sase-24.4 ───────────────────────────────────────────  2 agents · 2 running    ││    18 `stop_time`; simply adding their statuses to the patch predicate would still render the old finished planner        │
│  │  │  ⚡ sase (RUNNING) ×4 ◆ sase-24.4.4 @sase-24 @sase-24.4.4                   5m    ││       duration                                                                                                            │
│  │  │  ⚡ sase (RUNNING) ×4 ◆ sase-24.4.3 @sase-24 @sase-24.4.3                5m11s    ││    19 rather than a live active child runtime.                                                                            │
│                                                                                         ││    20                                                                                                                     │
│  ⏳ Waiting ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━  6 agent    ││    21 ## Goal                                                                                                             │
│  │  sase (WAITING) @sase-24 @acw                                                        ││    22                                                                                                                     │
│  │  ▎ sase-24 ────────────────────────────────────────────────────────────  5 agents    ││    23 Make the Agents tab runtime suffix tick once per second for every visible agent/workflow row that has active        │
│  │  │  ⚡ sase (WAITING) ◆ sase-24 @sase-24 @sase-24                                    ││       running                                                                                                             │
│  │  │  ⚡E sase (WAITING) ◆ sase-24.6.0 @sase-24 @sase-24.6.0                           ││    24 work underneath it, including parent rows displayed as `PLAN APPROVED`, `EPIC APPROVED`, and related active         │
│  │  │  ⚡E sase (WAITING) ◆ sase-24.5.0 @sase-24 @sase-24.5.0                           ││       handoff                                                                                                             │
│  │  │  ▸ sase-24.4 ───────────────────────────────────────────────────────  2 agents    ││    25 states.                                                                                                             │
│  │  │  sase (WAITING) ◆ sase-24.4 @sase-24 @sase-24.4                                   ││    26                                                                                                                     │
│  │  │  ⚡ sase (WAITING) ◆ sase-24.4.6 @sase-24 @sase-24.4.6                            ││    27 ## Design                                                                                                           │
│                                                                                         ││    28                                                                                                                     │
...
│  │  ▎ sase-24 ────────────────────────────────────────────────────────────  3 agents    ││       and patch                                                                                                           │
│  │  │  ▸ sase-24.4 ───────────────────────────────────────────────────────  3 agents    ││    30 eligibility agree.                                                                                                  │
│  │  │  ⚡ sase (DONE) ×5 ◆ sase-24.4.2 @sase-24 @sase-24.4.2       00:14:59 · 10m39s    ││                                                                                                                           │
│  │  │  ⚡ sase (DONE) ×5 ◆ sase-24.4.5 @sase-24 @sase-24.4.5        00:04:01 · 8m41s    ││    ▾ 49 more lines below                                                                                                  │
│  │  │  ⚡E sase (EPIC CREATED) ×6 @sase-24 @sase-24.4.0.plan     May 5 23:56 · 6m55s    ││                                                                                                                           │
└─────────────────────────────────────────────────────────────────────────────────────────┘└──────────────────────────────────────────────────── Lines 1-30 of 79 ─────────────────────────────────────────────────────┘
