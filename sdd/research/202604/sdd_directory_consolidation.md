...
5. **Tooling that scans `plans/`.** Anything outside `src/sase/` (skills, mentor scripts, retired-hg-plugin plugin,
...
10. **Second-pass external scan.** Known sibling repos mostly do not hard-code SDD paths. Hits found on 2026-04-30:
    ...
    `retired-hg-plugin`, `sase-nvim`, `~/.local/share/chezmoi/home/dot_config/sase`, or `~/.config/sase` for the scanned
