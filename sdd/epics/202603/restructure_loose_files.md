...
4. **Check plugin repos** (`../sase-github`, `../retired-hg-plugin`, `../sase-telegram`) for old imports — update if found
...
2. Grep plugin repos (`../sase-github`, `../retired-hg-plugin`, `../sase-telegram`) for old import paths — update if found
