...
- `../retired-hg-plugin/src/retired_hg_plugin/xprompts/hg.yml` — add `tags: vcs`
...
- `../retired-hg-plugin/src/retired_hg_plugin/xprompts/crs.md` — add `tags: crs` to frontmatter
