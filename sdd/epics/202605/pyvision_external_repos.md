...
bead_id: sase-2j
tier: epic
prompt: sdd/prompts/202605/pyvision_external_repos.md
---
...
- Vendored SASE copy: `tools/executable_pyvision-260512` or its next date-stamped replacement
- SASE invocation: `BD_COMMAND=tools/sase_bead .venv/bin/python tools/executable_pyvision-260512 src/sase`
...
- `tools/executable_pyvision-260512` or its date-stamped successor
- `Justfile`
- `tools/AGENTS.md`
