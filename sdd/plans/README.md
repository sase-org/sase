...
separate from bead tier metadata. Canonical committed run prompts are archived in the agents sidecar under
`prompts/<YYYYMM>/`; historical `prompts/` subdirectories here remain readable during migration.
