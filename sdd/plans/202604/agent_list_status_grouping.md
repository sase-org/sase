...
- Google Chat `.list` is implemented in `sase-gchat/src/sase_gchat/scripts/sase_gc_inbound.py::_format_running_agents`.
...
cd /home/bryan/projects/github/sase-org/sase-gchat && just check
```
