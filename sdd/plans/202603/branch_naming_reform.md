...
5. **sase-google unchanged**: The Mercurial provider's behavior must not change.
...
preserves Mercurial behavior without any changes to sase-google.
...
## Phase 3: End-to-End Validation and sase-google Compatibility
...
| Run `just check` in sase-google repo | Verify NO changes needed and existing tests pass                                                   |
