...
5. **retired-hg-plugin unchanged**: The Mercurial provider's behavior must not change.
...
preserves Mercurial behavior without any changes to retired-hg-plugin.
...
## Phase 3: End-to-End Validation and retired-hg-plugin Compatibility
...
| Run `just check` in retired-hg-plugin repo | Verify NO changes needed and existing tests pass                                                   |
