...
- Google Chat plan approval numbered options in `../sase-gchat`.
...
2. Update Google Chat presentation only.
   - In `../sase-gchat/src/sase_gchat/formatting.py`, change `Option("🚀 Quest", "run")` to `Option("Approve", "run")`.
   ...
   - Leave `../sase-gchat/src/sase_gchat/inbound.py` behavior unchanged.
...
4. Update tests.
   ...
   - Google Chat:
     - Update `../sase-gchat/tests/test_formatting.py`, `../sase-gchat/tests/test_inbound.py`,
       `../sase-gchat/tests/test_integration.py`, and `../sase-gchat/tests/test_externally_handled_cleanup.py` fixtures
...
5. Update documentation.
   - Replace current user-facing plan option lists in:
     ...
     - `../sase-gchat/README.md`
     - `../sase-gchat/docs/outbound.md`
