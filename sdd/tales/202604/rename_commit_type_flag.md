...
### Phase 3: Plugin Repo (sase-google)

8. **`../sase-google/src/sase_google/xprompts/split_executor.md:36`** — Change `-M create_pull_request` to
...
- `just check` in sase-google repo
