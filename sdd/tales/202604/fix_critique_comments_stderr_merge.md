...
shell script. On a remote machine that uses the `../legacy-mercurial-plugin` plugin repo, this command fails with:
...
- No changes to the `legacy-mercurial-plugin` plugin repo.
