...
In `retired-hg-plugin/src/retired_hg_plugin/default_config.yml`, the `bugs` mentor in the `code` profile (line 100-104) has
...
### Phase 1: Fix the YAML (retired-hg-plugin repo)

**File:** `retired-hg-plugin/src/retired_hg_plugin/default_config.yml` (line 100-104)
