...
- These built-in xprompt will have the same `prompt_part` used by the ../sase-google workflows currently, but will NOT
...
below. The numbers correspond to the section numbers in the research/unified_vcs_commit_prompt_questions.md file, which
...
- We should tag the `#no_cl_ops` xprompt in the ../sase-google repo with "append_to_pr". We should also define a new
