...
snippet that will be shown to users in the mentor review panel in the TUI. We should instruct mentors to use this
command to verify the JSON they intend to reply with is correct. Think this through thoroughly and create a plan.
