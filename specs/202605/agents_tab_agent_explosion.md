...
│  │  ▸ d ─────────────────────────────────────────────────────────  3 agents · 3 awaiting    ││  │  │  ⚡ sase (RUNNING) ×4 ◆ sase-1t.3 @sase-1t.3                       1m59s    ││                                  │
...
│  │  ⚡ sase (RUNNING) ×4 ◆ sase-1t.3 @sase-1t.3                                    8m32s    ││  │  │  ⚡ sase (WAITING) ◆ sase-1r.4 @sase-1r.4                                   ││                                  │
│  │  ⚡ sase (RUNNING) ×4 ◆ sase-1s.4 @sase-1s.4                                    2m51s    ││  ──────────────────────────────────────────────────                                                                   │
