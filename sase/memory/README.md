...
- `sase/memory/sase.md` is always generated by SASE and captures linked repositories
  plus workspace rules. `sase/memory/sase_beads.md` is generated only for SASE-managed
  project repositories and provides shared bead workflow guidance.
