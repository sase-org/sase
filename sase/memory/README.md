...
- `sase/memory/sase.md` is always generated by SASE and captures linked repositories
  ...
  `sase/memory/sase_beads.md` for shared bead workflow guidance,
  `sase/memory/sase_flags.md` for feature flag guidance, and `sase/memory/sase_sizes.md`
  for size guidance.
