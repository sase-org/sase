...
- Description: Read this note before relying on any of these SASE glossary terms and
  ...
  task) - Proc Shell - Sase Agent (aka agent) - Sase Monitor (aka monitor) - Sase Node
  (aka node) - Sase Project (aka project) - Sase Repo (aka repo) - Sase Shell (aka
  shell) - Sase Workspace (aka workspace) - Stitch - Xprompt - Xprompt Memory (aka
