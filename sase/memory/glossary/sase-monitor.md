...
A sase monitor is a session-attached proc shell that runs one long command under a
...
active monitor at a time; monitor members are named `<session>--mon`, then `--mon-0`,
