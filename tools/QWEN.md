...
Any script in this directory that has a suffix of the form `-YYmmdd` (ex: `pyvision-260708`) was vendored into this repo
...
### How do I whitelist a symbol for `pyvision-260708`? When am I allowed to do so?
...
- When working an epic (a bead that has been broken down into phases), it may be necessary to ignore one or more symbols
  ...
  to be ignored.
- When a symbol is used by a non-Python file or another reference that pyvision cannot discover, it can be ignored by
