"""Tests for the ``llm.default`` doctor check."""
...
from sase.doctor.checks_providers import _check_llm_default
...
def test_llm_default_accepts_configured_agy_executable_path(
    ...
    assert check.data["model_resolutions"]["large"] == "gemini-3.7-flash-high"
    assert check.data["auth_status"] == "not_verified"
