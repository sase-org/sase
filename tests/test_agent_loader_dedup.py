...
def test_embedded_vcs_hidden_by_workflow_axe_pid() -> None:
    """Test VCS hiding works when axe agent is WORKFLOW type (from workflow_state.json).
    ...
    hide the embedded VCS workspace claim.
    """
