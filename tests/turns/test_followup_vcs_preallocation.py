...
from tests.gate_turn.test_followup_launch import (
    _SETTLE_TIMEOUT,
    _envelope,
    _fake_result,
    _make_member,
...
def test_launch_shell_followup_without_vcs_still_falls_back_to_workspace_zero(
    ...
    monkeypatch.setattr(
        "sase.turns.followup._workspace_dir_for_num",
        lambda project_name, workspace_num: str(primary),
    )
    monkeypatch.setattr(
        "sase.turns.followup._workspace_is_claimed",
...
def test_launch_shell_followup_vcs_uses_fresh_pool_workspace_when_original_is_taken(
    ...
    monkeypatch.setattr("sase.turns.followup.claim_next_axe_workspace_dir", claim_pool)
...
def test_launch_shell_followup_vcs_records_not_launchable_when_pool_is_exhausted(
    ...
    monkeypatch.setattr(
        "sase.turns.followup.claim_next_axe_workspace_dir",
...
def test_gh_gate_followup_is_spawned_with_preallocation_env(
    ...
    monkeypatch.setattr("sase.gate_turn.followup.spawn_agent_subprocess", fake_spawn)
