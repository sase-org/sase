...
def test_get_failing_hooks_for_fix_basic() -> None:
    ...
    from sase.ace.hooks.queries import get_failing_hooks_for_fix
...
def test_get_failing_hook_entries_for_fix_basic() -> None:
    ...
    from sase.ace.hooks.queries import get_failing_hook_entries_for_fix
...
def test_get_failing_hooks_for_summarize_basic() -> None:
    ...
    from sase.ace.hooks.queries import get_failing_hooks_for_summarize
...
def test_get_failing_hook_entries_for_summarize_basic() -> None:
    ...
    from sase.ace.hooks.queries import get_failing_hook_entries_for_summarize
...
def test_has_failing_hooks_for_fix_true() -> None:
    ...
    from sase.ace.hooks.queries import has_failing_hooks_for_fix
...
def test_apply_hook_suffix_update_basic() -> None:
    ...
    from sase.ace.hooks.queries import _apply_hook_suffix_update
...
def test_apply_clear_hook_suffix_basic() -> None:
    ...
    from sase.ace.hooks.queries import _apply_clear_hook_suffix
...
def test_is_proposal_entry_true() -> None:
    ...
    from sase.ace.hooks.history import is_proposal_entry
...
def test_is_test_target_hook_true() -> None:
    ...
    from sase.ace.hooks.queries import _is_test_target_hook
...
def test_create_test_target_hook() -> None:
    ...
    from sase.ace.hooks.queries import _create_test_target_hook
...
def test_hook_has_fix_excluded_suffix_true() -> None:
    ...
    from sase.ace.hooks.queries import _hook_has_fix_excluded_suffix
