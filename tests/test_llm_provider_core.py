...
def test_resolve_model_provider_explicit_syntax() -> None:
    ...
    assert resolve_model_provider("codex/gpt-6-luna") == ("codex", "gpt-6-luna")
...
def test_resolve_model_provider_implicit_mapping() -> None:
    ...
    assert resolve_model_provider("gpt-6-luna") == ("codex", "gpt-6-luna")
    assert resolve_model_provider("gpt-5.6-sol") == ("codex", "gpt-5.6-sol")
    assert resolve_model_provider("gpt-5.6-luna") == ("codex", "gpt-5.6-luna")
    assert resolve_model_provider("gpt-5.6-terra") == ("codex", "gpt-5.6-terra")
...
def test_model_short_alias_map_contains_codex_entries() -> None:
    ...
    assert aliases.get("gpt-6-luna") == "gpt6luna"
