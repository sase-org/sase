"""Tests for sase.status_state_machine module."""
...
from sase.status_state_machine.field_updates import _apply_cl_update
...
def test_remove_ready_to_mail_suffix() -> None:
    ...
    from sase.status_state_machine import remove_ready_to_mail_suffix
