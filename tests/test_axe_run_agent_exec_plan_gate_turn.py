...
def _fake_record(*, gate_state: str, artifacts_dir: str) -> GateTurnRecord:
...
def _fake_creation(*, gate_state: str, artifacts_dir: str) -> GateTurnCreation:
...
def test_non_auto_creates_gate_turn_and_ends_gated(
    tmp_path: Path,
    ...
    monkeypatch.setattr(
        "sase.plan_gate_turn.create_plan_gate_turn", lambda *a, **k: creation
    )
