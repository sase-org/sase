...
Phase 2A (sase-17.1) of `sdd/tales/202604/rust_backend_phase2_query.md` captured
the optimized Python baseline before any Rust query backend landed. Phase 4 of
`sdd/tales/202604/query_batch_persistent_corpus.md` extended the same harness with
