...
_REVIEWED_PATH_PASSING_CONTEXTS: dict[str, PathPassingReview] = {
    "src/sase/agent/_agent_session_promotion.py:promote_agent_to_agent_session": PathPassingReview(
        lifecycle_coverage=(
    ...
    "src/sase/shells/member.py:create_agent_session_shell_member": PathPassingReview(
        lifecycle_coverage=(
            ...
            "artifact index mutation updater for the same artifacts directory."
        ),
    ),
    ...
    "src/sase/agent/_restart_recovery.py:_write_recovery_files": PathPassingReview(
        exemption=(
    ...
    "src/sase/continuation_capture/agent_delta.py:_parent_node_ids": PathPassingReview(
        exemption=(
            ...
            "the caller writes a new continuation record."
        ),
    ),
    ...
    "src/sase/history/chat_fork/clan.py:_format_clan_member": PathPassingReview(
        exemption=(
    ...
    "src/sase/gate_shell/settlement.py:_read_meta": PathPassingReview(
        exemption=(
            ...
            "before all marker writes go through the existing atomic metadata "
            "and done-marker helpers."
        ),
    ),
    "src/sase/gate_shell/transaction.py:_read_meta": PathPassingReview(
        exemption=(
            ...
            "before any gate-shell member mutation uses the dedicated creation "
            "and claim helpers."
        ),
    ),
