...
def test_process_snippet_colon_syntax_numeric_arg() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#issue:123")
...
def test_process_snippet_colon_syntax_with_dots() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#file:test.txt")
...
def test_process_snippet_colon_syntax_with_hyphens() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#tag:foo-bar-baz")
...
def test_process_snippet_colon_syntax_with_underscores() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#var:my_variable")
...
def test_process_snippet_colon_syntax_terminates_at_whitespace() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#greet:world and more text")
...
def test_process_snippet_colon_syntax_terminates_at_closing_paren() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("(#foo:bar)")
...
def test_process_snippet_colon_and_paren_in_same_prompt() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#greet:world and #msg(Alice, hi)")
...
def test_process_snippet_jinja2_named_args() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#greet(name=World)")
    assert result == "Hello World!"
...
def test_process_snippet_jinja2_multiple_named_args() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#msg(sender=Alice, message=hello)")
    assert result == "Alice says hello"
...
def test_process_snippet_jinja2_quoted_named_args() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references('#greet(name="Big World")')
...
def test_process_snippet_jinja2_mixed_args() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#msg(Alice, message=hello)")
    assert result == "Alice says hello"
...
def test_process_snippet_jinja2_conditional() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#greet(name=Bob, formal=yes)")
...
def test_process_snippet_jinja2_default_filter() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#greet()")
    assert result == "Hello World!"
...
def test_process_snippet_jinja2_upper_filter() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#shout(text=hello)")
    assert result == "HELLO"
...
def test_process_snippet_legacy_and_jinja2_together() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#legacy(World) and #jinja(name=Universe)")
...
def test_process_snippet_plus_syntax_terminates_at_whitespace() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#flag+ and more text")
...
def test_process_snippet_plus_and_other_syntax_in_same_prompt() -> None:
    ...
    with patch(
        ...
        result = process_xprompt_references("#enabled+ #name:foo #count(42)")
...
def test_process_snippet_plus_syntax_equivalent_to_colon_true() -> None:
    ...
    with patch(
        ...
        result_plus = process_xprompt_references("#flag+")
        result_colon = process_xprompt_references("#flag:true")
