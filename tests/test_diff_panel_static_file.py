...
def test_display_static_file_reads_and_renders(tmp_path: Any) -> None:
    ...
    from sase.ace.tui.widgets.diff_panel import _EXTENSION_TO_LEXER, AgentDiffPanel
...
def test_display_static_file_handles_missing_file(tmp_path: Any) -> None:
    ...
    from sase.ace.tui.widgets.diff_panel import AgentDiffPanel
...
def test_extension_to_lexer_mapping() -> None:
    ...
    from sase.ace.tui.widgets.diff_panel import _EXTENSION_TO_LEXER
