...
def test_archive_patch_fails_without_pr(make_patch) -> None:  # type: ignore[no-untyped-def]
    ...
    success, error = archive_patch(patch)
...
def test_archive_patch_fails_with_non_terminal_children(make_patch) -> None:  # type: ignore[no-untyped-def]
    ...
    with mock_patch("sase.ace.archive.find_all_patches", return_value=[parent, child]):
        with mock_patch(
            ...
            with mock_patch(
                ...
                with mock_patch(
                    ...
                    with mock_patch(
                        ...
                        with mock_patch("sase.ace.archive.release_workspace"):
...
def test_archive_patch_claims_workspace_100_plus(make_patch) -> None:  # type: ignore[no-untyped-def]
    ...
    with mock_patch("sase.ace.archive.find_all_patches", return_value=[patch]):
        with mock_patch(
            "sase.ace.archive.get_first_available_axe_workspace", return_value=100
        ) as mock_get_ws:
            with mock_patch(
                ...
                with mock_patch(
                    ...
                    with mock_patch(
                        ...
                        with mock_patch(
                            ...
                            with mock_patch(
                                "sase.ace.archive.rename_patch_with_references"
                            ):
                                with mock_patch(
                                    ...
                                    with mock_patch(
                                        ...
                                        success, _error = archive_patch(patch, console)

    assert success is True
    mock_get_ws.assert_called_once_with(patch.file_path)
