"""Shared helpers for agent-loader self-heal tests."""
...
@pytest.fixture
def clear_cleaned_artifact_cache() -> Iterator[None]:
    """Clear the module-level cleanup cache around tests that touch it."""
