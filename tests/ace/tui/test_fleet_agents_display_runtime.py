"""Session elapsed / current-run survival through fleet projection."""
...
def test_remote_agent_session_elapsed_and_current_run_survive_projection() -> None:
    started = 1_800_000_000.0
    run_started = 1_800_000_600.0
    observed = 1_800_001_200.0
    summary = fleet_summary(
        agent_id="elapsed-session",
        agent_name="elapsed-session",
        status="WORKING TALE",
        started_at_unix=started,
        run_started_at_unix=run_started,
        observed_at_unix=observed,
        legacy_family_id="elapsed-session",
        legacy_family_role="root",
    )
    child = fleet_summary(
        agent_id="elapsed-session--code",
        run_id="run-code",
        agent_name="elapsed-session--code",
        status="WORKING TALE",
        legacy_family_id="elapsed-session",
