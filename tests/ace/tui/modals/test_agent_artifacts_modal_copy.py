"""Clipboard and path-copy tests for the agent artifact selection modal."""
...
from sase.ace.tui.modals.agent_artifacts_modal import AgentArtifactSelectionModal
...
async def test_artifact_modal_Y_copies_workspace_relative_path_and_stays_open(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
...
async def test_artifact_modal_Y_without_workspace_falls_back_to_home_relative_path(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    home = tmp_path / "home"
...
async def test_artifact_modal_Y_uses_workspace_relative_source_path_for_global_artifact(
    tmp_path: Path,
    monkeypatch: pytest.MonkeyPatch,
) -> None:
    workspace = tmp_path / "workspace"
