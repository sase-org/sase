...
def test_projected_group_opens_links_panel_without_trail() -> None:
    ...
    app = _App(
        ...
        panes={"files": _Pane(targets=())},
    )

    app._follow_link_number(1)

    assert app.notifications == [("Links panel is not yet available", "warning")]
