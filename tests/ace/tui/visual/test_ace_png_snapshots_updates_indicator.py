...
async def test_updates_indicator_with_neighbors_png_snapshot(
    ...
    """Mixed + core badge next to the proc/monitor gears in the procs group."""
    import sase.ace.tui.widgets.alias_overrides_indicator as alias_overrides_indicator

    from sase.ace.tui.widgets import ProcIndicator
    ...
    async with AcePage(query='"visual"', patches=patches()) as page:
        ...
        await wait_for_state(
            page,
            lambda: proc_indicator.render().plain.strip() != "",
