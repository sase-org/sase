...
async def test_artifacts_beads_collapsed_relations_rail_png_snapshot(
    ...
    async with AcePage(query='"visual"', patches=patches()) as page:
        ...
        # alpha-1 is an epic: the pane reports children, not a parent. Its
        # linked plan is an app-level Link Rail concern now (bead:sase-ug.10),
        # not this pane's relations rail.
