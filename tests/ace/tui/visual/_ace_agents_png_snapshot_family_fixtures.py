...
def running_family_runtime_agents() -> list[Agent]:
    ...
    root = Agent(
        ...
        agent_session="visual-runtime-family",
        agent_session_role="root",
...
def settled_monitor_family_agents() -> list[Agent]:
    ...
    root = Agent(
        ...
        agent_session="visual-monitor-family",
        agent_session_role="root",
        role_suffix="--0",
        llm_provider="codex",
        model="gpt-5",
...
def parallel_family_agents() -> list[Agent]:
    root = Agent(
        ...
        agent_session="visual-parallel-family",
        agent_session_role="root",
...
def family_and_lone_planner_agents() -> list[Agent]:
    ...
    lone_planner = Agent(
        ...
        agent_session="visual-lone-planner",
        agent_session_role="root",
        plan_chain_root=True,
        appears_as_agent=True,
    )
