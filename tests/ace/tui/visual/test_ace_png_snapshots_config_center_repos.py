"""ACE PNG snapshot for the Admin Center Repos sub-tab."""
...
async def test_config_center_repos_subtab_png_snapshot(
    ...
    async with AcePage(query='"visual"', patches=patches()) as page:
        ...
        ace_png_visual.assert_page_png(
            page,
            "config_center_repos_tab_120x40",
            title="ACE SASE Admin Center — repository inventory",
        )
