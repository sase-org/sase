...
Non-Axe snapshots (ChangeSpecs/Agents tabs) live in
``test_ace_png_snapshots``. Shared fixtures live in
...
async def test_axe_controlled_chop_output_png_snapshot(
    ...
    patch_startup_loaders(monkeypatch, axe_data=_axe_controlled_chop_fixture())
