...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("- item", 3, TextEdit(start=0, end=0, text="  ", cursor=5)),
        ("- item", 6, TextEdit(start=0, end=0, text="  ", cursor=8)),
        (
            "intro\n  - item",
            12,
            TextEdit(start=6, end=6, text="  ", cursor=14),
        ),
        ("plain prose", 0, None),
        ("\t- item", 2, None),
        ("* item", 2, None),
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("  - item", 5, TextEdit(start=0, end=2, text="", cursor=3)),
        (
            "intro\n   - item",
            14,
            TextEdit(start=6, end=8, text="", cursor=12),
        ),
    ],
    ids=[
        "column-zero",
