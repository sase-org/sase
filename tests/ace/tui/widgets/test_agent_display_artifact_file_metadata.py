"""Tests for agent display artifact-file metadata."""
...
class TestArtifactFileMetadata:
...
""",
        ...
        explicit = store_explicit_artifact_file(explicit_source, artifacts_dir)
