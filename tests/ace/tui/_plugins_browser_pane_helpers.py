...
def _agent_cli_statuses() -> tuple[AgentCliStatus, ...]:
    ...
    return (
        ...
        AgentCliStatus(
            ...
            executable=None,
            installed_version=None,
            latest_version="1.3.0-R3401.1",
            install_method=InstallMethod.NOT_INSTALLED,
            update_available=False,
            docs_url="https://developers.facebook.com/code",
        ...
        AgentCliStatus(
            ...
            install_method=InstallMethod.NOT_INSTALLED,
            update_available=False,
            docs_url="https://antigravity.dev/download",
            install_hint="Download Antigravity from the vendor site",
