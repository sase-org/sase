"""Startup grouping defaults for the ACE TUI."""
...
def test_startup_ignores_stale_agent_grouping_mode_file(
...
def test_startup_ignores_stale_changespec_grouping_mode_file(
    tmp_path: Path, monkeypatch: Any
) -> None:
    sase_dir = tmp_path / ".sase"
    sase_dir.mkdir()
