...
def test_running_record_carries_agent_meta(fixture_root: Path) -> None:
    ...
    assert rec.agent_meta.agent_clan == "legacy_clan"
    assert rec.agent_meta.agent_session is None
    assert rec.agent_meta.agent_session_role is None
    assert rec.agent_meta.agent_session_parallel is True
