...
def gate_turn_home(monkeypatch: pytest.MonkeyPatch, tmp_path: Path) -> Path:
...
def patch_gate_turn_project_records(
    monkeypatch: pytest.MonkeyPatch,
    artifacts_dirs: list[str],
) -> None:
    """Make ``sase.gate_turn.store`` see exactly *artifacts_dirs*, read live."""
    from sase.gate_turn import store as store_module
