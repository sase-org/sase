    ...
    *,
    ...
    for repo in repos:
        try:
            ...
            commits = provider.log(cwd=repo.path, limit=limit)  # type: ignore[attr-defined]
    ...
    aggregated = aggregate_commit_log(per_repo, limit)
    return VcsLogResult(
...
def run_vcs_log(
    *,
    ...
    collected = collect_vcs_log(
        resolved.repos, limit=limit, provider_factory=provider_factory
    )
    return VcsLogResult(
