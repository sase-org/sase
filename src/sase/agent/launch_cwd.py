...
def launch_planned_bead_work_agents(
    *,
    ...
    per-segment fan-out probing (which would expand those bead xprompts only to
    learn there is no fan-out), and the CWD project re-parse — by feeding
    ...
    allow_bypass = _internal_agent_name_bypass_for_launch(None, segment_extra_env)
