...
:class:`~sase.notification_gates.model_turn.GateTurnSpec` rather than
...
def resolve_gate_followup(
    ...
    *,
    ...
    next_policy: GateTurnBranchSpec | GateTurnNext
...
def _parse_shell(envelope: dict[str, Any]) -> GateTurnSpec | None:
