...
from sase.gate_turn.log import append_gate_turn_log_text
...
def hold_gate_turn_claim_for_settlement(
    project_file: str,
...
def _restore_live_creator_claim(
    ...
    *,
    ...
    result = restore_gate_turn_claim(
        project_file,
        move=move,
        cl_name=creator_claim.cl_name,
