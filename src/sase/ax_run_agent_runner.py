#!/usr/bin/env python3
"""Background run agent runner for sase ace TUI (legacy quarantined copy).
...
from sase.ax_runner_utils import install_sigterm_handler, prepare_workspace, was_killed
