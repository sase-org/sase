...
from sase.gate_turn import GateTurnCreation, create_gate_turn, list_gate_turns
...
def _question_gate_turn_spec(
    ...
    *,
    ...
    """Build the question gate's v3 request body plus its additive turn block.
