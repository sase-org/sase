"""Compatibility supervisor for already-running legacy proc rows.
...
def _run_supervisor(proc_id: str) -> int:
    """Own one recorded legacy proc from child spawn through terminal status."""
...
def _parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Supervise one legacy SASE proc.")
