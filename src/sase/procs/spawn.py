...
_SUPERVISOR_BOOTSTRAP_PID_FILE_NAME = ".supervisor_bootstrap_pid"
...
def _spawn_bootstrap(
    ...
    *,
    ...
    try:
        pid_file = _supervisor_pid_file(proc_id)
        ...
        try:
            _supervisor_pid_file(proc_id).unlink()
        except OSError:
            pass


def _supervisor_pid_file(proc_id: str) -> Path:
    return proc_runtime_dir(proc_id) / _SUPERVISOR_BOOTSTRAP_PID_FILE_NAME
