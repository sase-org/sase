...
from sase.rich_utils import print_status, print_workflow_header
...
from sase.split_spec import parse_split_spec, validate_split_spec
...
class SplitWorkflow(BaseWorkflow):
    ...
    def _run_split_workflow(
        ...
        initialize_sase_log(artifacts_dir, "split", workflow_tag)
        ...
        finalize_sase_log(artifacts_dir, "split", workflow_tag, True)
