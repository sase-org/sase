...
from sase.chat_history import list_chat_histories, load_chat_history, save_chat_history
...
from sase.shared_utils import dump_yaml, ensure_str_content
from sase.split_spec import (
    SplitSpec,
...
def generate_spec_with_agent(
    ...
    while True:
        ...
        # Load the previous chat history (same pattern as sase rerun)
...
def build_split_prompt(
    ...
    Returns:
        The formatted prompt string.
    """
    # Build the note for sase commit -n option
