...
UPDATE_PRODUCERS: tuple[ProcProducerSite, ...] = (
    ...
    site(
        "plugin.install",
        "src/sase/ace/tui/modals/plugins_browser_install_single.py",
        "_submit_install_task",
        "duck_submit_durable",
        "PLUGIN_INSTALL",
        "durable",
        "PluginSingleInstallActionsMixin._submit_install_task",
        "sase plugin install",
        identifiers=("plugin",),
    ...
    site(
        ...
        "plugin-install",
        "ui_only",
        "PluginSingleInstallActionsMixin._submit_install_many_task",
        "",
        identifiers=("plugins",),
        result_kind="plugin.install",
    ...
    site(
        "plugin.agent_cli_install",
        "src/sase/ace/tui/modals/plugins_browser_agent_clis_install.py",
        "_submit_agent_cli_install_task",
        "session_worker",
        "agent-cli-install",
        "ui_only",
        "AgentCliInstallActionsMixin._submit_agent_cli_install_task",
        "",
        identifiers=(),
        result_kind="agent-cli.install",
        concurrency_keys=("agent-cli-install",),
        restart_recovery="not durable; session-local install workflow",
    ),
    site(
        "plugin.combined_install",
        "src/sase/ace/tui/modals/plugins_browser_install_combined.py",
        "_submit_combined_install_task",
        "session_worker",
        "agent-cli-plugin-install",
        "ui_only",
        "PluginCombinedInstallActionsMixin._submit_combined_install_task",
        "",
        identifiers=("plugins",),
        result_kind="plugin.install",
