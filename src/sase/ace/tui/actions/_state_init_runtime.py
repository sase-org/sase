...
def init_runtime_state(
    ...
    *,
    ...
    # Deferred agent-session plan-preview warmup coalescing. Completion rows
    # read session previews from memory only; plan/bead resolution runs after
    # Agents loads or after a completion menu sees an unresolved session.
    ...
    self._agent_session_preview_scan_source = "unknown"
    self._agent_session_preview_async_tasks = set()
