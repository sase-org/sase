"""ChangeSpec history navigation actions for the ace TUI app."""
...
class ChangeSpecHistoryNavigationMixin(NavigationMixinBase):
    """Mixin providing ChangeSpec history navigation."""
