...
def _agent_panel_border_title(
    ...
    *,
    ...
    counts: _AgentPanelCounts | None = None,
) -> Text:
...
class PanelsMixin:
        ...
        *,
        ...
        for idx, key in enumerate(panel_keys):
            ...
            widget.border_title = _agent_panel_border_title(
                ...
                len(panel_agents),
                merge_tag_panels=merge_tag_panels,
                counts=_agent_panel_counts(panel_agents, unread),
            )
            if idx == 0:
    ...
    def _try_patch_agent_row(self, agent: Agent) -> bool:
        ...
        widget.border_title = _agent_panel_border_title(
            ...
            len(slot.agents),
            merge_tag_panels=getattr(self, "_agent_panels_grouped", False),
            counts=_agent_panel_counts(slot.agents, unread),
        )
