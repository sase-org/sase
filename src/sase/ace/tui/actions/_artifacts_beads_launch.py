"""Work-launch actions for the Artifacts Beads pane."""
...
class ArtifactsBeadsLaunchActionsMixin(ArtifactsBeadsCommonMixin):
    """Launch task and epic work from the selected bead."""
