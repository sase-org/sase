...
_LAZY_EXPORTS = {
    ...
    "HistoryPane": (".history_pane", "HistoryPane"),
    ...
    "InitPlanAction": (".init_plan_modal", "InitPlanAction"),
    "InitPlanDecision": (".init_plan_modal", "InitPlanDecision"),
    "InitPlanModal": (".init_plan_modal", "InitPlanModal"),
    ...
    "PromptsModal": (".prompts_modal", "PromptsModal"),
    "PromptsOrigin": (".prompts_modal", "PromptsOrigin"),
    "PromptsOriginKind": (".prompts_modal", "PromptsOriginKind"),
    "PromptsResult": (".prompts_modal", "PromptsResult"),
    "PromptsTab": (".prompts_modal", "PromptsTab"),
    ...
    "RefreshChoice": (".refresh_panel_modal", "RefreshChoice"),
    "RefreshPanelModal": (".refresh_panel_modal", "RefreshPanelModal"),
    "RefreshRow": (".refresh_panel_modal", "RefreshRow"),
    ...
    "StashPane": (".stash_pane", "StashPane"),
    ...
    "TrashActionResult": (".trash_pane", "TrashActionResult"),
    "TrashCopyRequested": (".trash_pane", "TrashCopyRequested"),
    ...
    "UsageRowStatus": (".refresh_panel_modal", "UsageRowStatus"),
