...
class _CommandDisplayItem:
    ...
    entry: CommandEntry
    marker: str  # "*", "~", or " "
    display_context: str  # Padded project/Patch context
    display_project: str
...
class CommandHistoryModal(OptionListNavigationMixin, ModalScreen[str | None]):
    ...
    def __init__(
        ...
        Args:
            current_cl: Patch name to prioritize in sorting.
    ...
    def _update_preview(self, item: _CommandDisplayItem) -> None:
        ...
        try:
            ...
            if item.entry.cl_name:
                meta_text.append("Patch: ", style="bold")
