"""Patch field agent loaders (HOOKS, MENTORS, COMMENTS)."""

from ....agent_tribes import REVIEW_AGENT_TRIBE
from ....patch import Patch, extract_pid_from_agent_suffix
from .._timestamps import parse_timestamp_from_suffix
from ..agent import Agent, AgentType


def load_agents_from_hooks(
    cs: Patch, bug: str | None, cl_num: str | None
) -> list[Agent]:
    """Load running agents from HOOKS field.

    Args:
        cs: The Patch to extract agents from.
        bug: Bug URL from the Patch, or None.
        cl_num: PR number from the Patch, or None.
        ...
        for msl in mentor_entry.status_lines:
            ...
            agents.append(
                Agent(
                    ...
                    stitch_id=mentor_entry.entry_id,
