...
_LAZY_EXPORTS = {
    ...
    "AgentLLMCallsPanel": (".llm_calls_panel", "AgentLLMCallsPanel"),
    ...
    "ArtifactPlaceholderPane": (
        ".artifacts.placeholder_pane",
        "ArtifactPlaceholderPane",
    ),
    "ArtifactsAgentsPane": (".artifacts.agents_pane", "ArtifactsAgentsPane"),
    ...
    "ArtifactsPatchesPane": (".artifacts.patches_pane", "ArtifactsPatchesPane"),
    ...
    "AgentInfoRow": (".launch_context_bar", "AgentInfoRow"),
    "ArtifactsHeader": (".launch_context_bar", "ArtifactsHeader"),
    "AxeInfoRow": (".launch_context_bar", "AxeInfoRow"),
    "LaunchContextBar": (".launch_context_bar", "LaunchContextBar"),
    "LaunchContextSource": (".launch_context_source", "LaunchContextSource"),
    "LinkRail": (".link_rail", "LinkRail"),
    "LLMOverrideIndicator": (".llm_override_indicator", "LLMOverrideIndicator"),
    "MonitorIndicator": (".proc_indicator", "MonitorIndicator"),
    "NotificationIndicator": (".notification_indicator", "NotificationIndicator"),
    "PatchDetail": (".patch_detail", "PatchDetail"),
    "PatchFilterBar": (".artifacts.patch_filter_bar", "PatchFilterBar"),
