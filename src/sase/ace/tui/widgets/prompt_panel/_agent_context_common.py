...
from sase.bead.touch_glyphs import (
    CLOSED_GLYPH as _SHARED_CLOSED_GLYPH,
    CREATED_GLYPH as _SHARED_CREATED_GLYPH,
    EDITED_GLYPH as _SHARED_EDITED_GLYPH,
    READ_GLYPH as _SHARED_READ_GLYPH,
    REMOVED_GLYPH as _SHARED_REMOVED_GLYPH,
    REOPENED_GLYPH as _SHARED_REOPENED_GLYPH,
    VIEWED_GLYPH as _SHARED_VIEWED_GLYPH,
)
...
COLOR_BEAD_CLOSED_GLYPH = "bold #5FD75F"
COLOR_BEAD_CLOSED_CAP = "#5FD75F"
COLOR_BEAD_CLOSED_PILL = "bold #1A1A1A on #5FD75F"
COLOR_BEAD_CLOSED_MUTED_GLYPH = "bold #8A8A8A"
COLOR_BEAD_CLOSED_MUTED_CAP = "#8A8A8A"
COLOR_BEAD_CLOSED_MUTED_PILL = "bold #1A1A1A on #8A8A8A"
COLOR_BEAD_RESOLUTION = "italic #BCBCBC"
COLOR_BEAD_REOPENED_SINCE = "italic #D7AF5F"
COLOR_BEAD_CLOSED_STALE = "dim strike"
COLOR_BEAD_CREATED_CAP = "#FFAF00"
COLOR_BEAD_CREATED_PILL = "bold #1A1A1A on #FFAF00"
COLOR_BEAD_CREATED_CHIP = "#FFAF00"

MEMORY_GLYPH = _SHARED_VIEWED_GLYPH
ARTIFACT_READ_GLYPH = _SHARED_READ_GLYPH
BEAD_CREATED_GLYPH = _SHARED_CREATED_GLYPH
BEAD_CLOSED_GLYPH = _SHARED_CLOSED_GLYPH
BEAD_REOPENED_GLYPH = _SHARED_REOPENED_GLYPH
BEAD_EDITED_GLYPH = _SHARED_EDITED_GLYPH
BEAD_REMOVED_GLYPH = _SHARED_REMOVED_GLYPH
GLOSSARY_GLYPH = "◈"
SKILL_GLYPH = "◆"
WORKSPACE_GLYPH = "▣"
EXTERNAL_REPO_GLYPH = "◆"
