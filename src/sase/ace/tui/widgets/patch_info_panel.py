"""Patch info panel showing count and refresh countdown."""
...
class PatchInfoPanel(Static):
    """Panel showing Patch position and auto-refresh countdown."""
    ...
    def __init__(self, **kwargs: Any) -> None:
        ...
        self._fold_stitches: FoldLevel = FoldLevel.COLLAPSED
    ...
    def _fold_commits(self) -> FoldLevel:
        return self._fold_stitches

    @_fold_commits.setter
    def _fold_commits(self, value: FoldLevel) -> None:
        self._fold_stitches = value
    ...
    def update_grouping_mode(self, label: str) -> None:
        """Update the active Patch grouping-strategy label.
    ...
    def update_position(self, position: int, total: int, marked_count: int = 0) -> None:
        ...
        Args:
            ...
            total: Total number of filtered patches
            marked_count: Number of marked Patches
        """
    ...
    def update_hidden_counts(self, reverted: int, submitted: int) -> None:
        """Update the hidden Patch counts.

        Args:
            reverted: Number of reverted/archived Patches hidden from the list.
            submitted: Number of submitted Patches hidden from the list.
        """
    ...
    def update_fold_states(
        ...
        Args:
            stitches: Fold level for the stitches section.
    ...
    def _build_content(self) -> Text:
        ...
        has_fold = not (
            self._fold_stitches == FoldLevel.COLLAPSED
