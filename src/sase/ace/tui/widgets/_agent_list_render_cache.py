...
def _runtime_signature(
    ...
    return (
        ...
        agent.gate_accent,
        agent.gate_label,
        agent.gate_execution_active,
        agent.gate_finalize_proc_id,
        agent.proc_id,
        ...
        tuple(getattr(wait_agent, "waiting_for_hoods", ())),
...
def agent_render_key(
    ...
    *,
    ...
    return (
        ...
        agent.monitor_followup_agent,
        agent.monitor_followup_degraded_reason,
        agent.monitor_host_completion_status,
        agent.gate_id,
        agent.gate_state,
        agent.gate_start_status,
        agent.gate_stop_status,
        ...
        wait_agent.queue_weight_explicit,
        wait_agent.queue_weight_invalid,
        wait_agent.queue_weight_error,
        wait_agent.wait_runners,
        wait_agent.wait_runners_explicit,
        wait_agent.queue_capacity,
        wait_agent.queue_capacity_explicit,
        wait_agent.queue_capacity_multiplier,
        ...
        agent.fleet_host_status,
        agent.fleet_host_feed_error,
        ...
        agent.fleet_dispatch_message,
        agent.fleet_dispatch_prompt,
        _freeze_jsonish(agent.fleet_dispatch_payload),
    ...
    *,
    ...
    member_sig = tuple(
        (
            ...
            a.fleet_host_waiting_count,
            a.fleet_host_failed_count,
            a.fleet_host_done_count,
            a.fleet_host_unknown_count,
            a.fleet_host_status,
            a.fleet_host_feed_error,
            a.fleet_freshness,
            a.fleet_host_cache_age_seconds,
            a.hidden,
            a.is_workflow_child,
            a.is_clan_container,
            a.tree_parent_key,
