...
_LAZY_EXPORTS = {
    ...
    "ArtifactPlaceholderPane": (".placeholder_pane", "ArtifactPlaceholderPane"),
    "ArtifactsDegradedPane": (".degraded_pane", "ArtifactsDegradedPane"),
    "ArtifactsAgentsPane": (".agents_pane", "ArtifactsAgentsPane"),
    ...
    "ArtifactsPatchesPane": (".patches_pane", "ArtifactsPatchesPane"),
    ...
    "LinkRequestState": (".entry_navigation", "LinkRequestState"),
