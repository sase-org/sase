...
DEFAULT_BINDINGS: list[BindingType] = [
    ...
    Binding(
        ...
        "Collapse Selected Workflow/Session / Scoped Agent Nodes/Clans/Groups / Hint Panel Fold / Compact LLM Calls / All",
        show=False,
    ),
    ...
    Binding("4", "show_artifacts_digit(4)", "Show Beads", show=False),
    ...
    Binding("E", "files_open_external", "Open Externally", show=False),
