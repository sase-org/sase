...
APP_COMMAND_META: tuple[AppCommandMeta, ...] = (
    ...
    (
        ...
        "Tabs",
        CL_ONLY,
        ("next artifact", "commits", "beads", "bugs", "files"),
    ),
    (
    ...
    # Commits sub-tab
    ("stitches_next", "Commits: next row", "Navigation", CL_ONLY, ("commit down",)),
    (
        "stitches_prev",
    ...
    ("stitches_view_selected", "Commits: view selected", "Display", CL_ONLY, ()),
    ("stitches_copy_sha", "Commits: copy SHA", "Display", CL_ONLY, ()),
    ("stitches_filters", "Commits: filter bar", "Display", CL_ONLY, ()),
    (
        "stitches_toggle_sdd",
    ...
    ("files_copy_reference", "Files: copy reference", "Display", CL_ONLY, ()),
    ...
    (
        ...
        "Collapse Agents group lanes, selected clan, remaining clans/groups; "
        "panel lanes/clans/groups/panel / compact tools detail / collapse all "
        "folds on other tabs",
        "Folding",
        ALL_TABS,
        (
