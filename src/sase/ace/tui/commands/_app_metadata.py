...
APP_COMMAND_META: tuple[AppCommandMeta, ...] = (
    ...
    # Folding
    ("hooks_or_collapse", "Toggle hooks / collapse", "Folding", ALL_TABS, ()),
    (
    ...
    ("expand_or_layout", "Expand entry / change layout", "Folding", ALL_TABS, ()),
    ("expand_all_folds", "Expand all folds", "Folding", ALL_TABS, ()),
