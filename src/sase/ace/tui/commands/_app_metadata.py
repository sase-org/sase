...
APP_COMMAND_META: tuple[AppCommandMeta, ...] = (
    ...
    (
        ...
        "Tabs",
        CL_ONLY,
        ("next artifact", "stitches", "commits", "beads", "bugs", "files"),
    ),
    (
    ...
    ("stitches_copy_sha", "Stitches: copy SHA", "Display", CL_ONLY, ()),
    ...
    (
        "stitches_refresh",
        "Stitches: refresh local refs",
        "Proposals & Sync",
        CL_ONLY,
        ("reload commits", "reload stitches"),
    ),
    # Plans sub-tab
