...
class MemoryPanelKeymaps:
    ...
    first_note: str = "g"
    last_note: str = "G"
    toggle_web: str = "space"
    next_strand: str = "s"
    prev_strand: str = "S"
    scroll_body_down: str = "ctrl+d"
    scroll_body_up: str = "ctrl+u"
    filter_notes: str = "slash"
    toggle_body_filter: str = "greater_than_sign"
    next_link: str = "tab"
    prev_link: str = "shift+tab"
    follow_link: str = "enter,l"
    travel_back: str = "backspace,h"
    next_scope: str = "p"
    prev_scope: str = "P"
    pick_scope: str = "ctrl+p"
    add_note: str = "a"
    edit_note: str = "e"
    delete_note: str = "d"
    publish: str = "I"
