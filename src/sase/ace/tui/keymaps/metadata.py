...
_BINDING_META: list[tuple[str, str, bool]] = [
    ...
    ("run_workflow", "Run / Re-run", False),
    ("agents_refresh", "Refresh", False),
    ("mail", "Mail", False),
    ...
    ("accept_proposal", "Accept / Answer", False),
    ("rebase", "Rebase", False),
    ...
    ("edit_spec", "Edit Spec / Content", False),
    ...
    ("cycle_artifacts_description", "Pane Description", False),
    ...
    ("check_dispatch_launch_outcome", "Check Dispatch Launch Outcome", False),
    ...
    ("next_chop_run", "Next Job Run", False),
    ...
    ("focus_next_service_panel", "Next Panel", False),
    ("focus_prev_service_panel", "Prev Panel", False),
...
_MEMORY_BINDING_META: tuple[tuple[str, str], ...] = (
    ...
    ("last_note", "Last Note"),
    ("toggle_web", "Expand/Collapse Web"),
    ("next_strand", "Next Strand"),
