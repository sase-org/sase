...
_BINDING_META: list[tuple[str, str, bool]] = [
    ...
    ("cycle_agents_subtab", "Next Agent Mode", False),
    ("cycle_agents_subtab_reverse", "Previous Agent Mode", False),
    ("toggle_agent_follow", "Follow Agent", False),
    ("view_agent_in_focus", "View in Focus", False),
