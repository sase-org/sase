...
def _agent_to_json(agent: AgentListEntry) -> dict[str, object]:
    ...
    return {
        ...
        "queue_weight": agent.wait.queue_weight,
        "queue_weight_explicit": agent.wait.queue_weight_explicit,
        "queue_weight_invalid": agent.wait.queue_weight_invalid,
        "queue_weight_error": agent.wait.queue_weight_error,
        "slot_requested_at": agent.wait.slot_requested_at,
        "runner_slots_in_use": agent.wait.runner_slots_in_use,
        "runner_occupied_capacity": agent.wait.runner_occupied_capacity,
        "runner_effective_limit": agent.wait.runner_effective_limit,
        "runner_admission_limit": agent.wait.runner_admission_limit,
        "runner_slot_queue_position": agent.wait.runner_slot_queue_position,
        "runner_slot_queue_size": agent.wait.runner_slot_queue_size,
        "runner_capacity_blockers": list(agent.wait.runner_capacity_blockers),
        "held_by": agent.wait.held_by,
        "hold_expires_at": agent.wait.hold_expires_at,
        "parent_agent_name": agent.parent_agent_name,
        "agent_family": agent.agent_session,
        "agent_family_role": agent.agent_session_role,
        "tribe": agent.tribe,
