# Research companion directory map

## Target

- Final asset: `src/sase/sdd/assets/research-directory-map.png`
- Size: 1600×900 PNG
- Intended use: generated README for each research companion repository
- Alt text:
  `Research swarm branches consolidate a monthly report and infographic in the research companion, which is lazily materialized with sase sdd path research --ensure.`
...
Primary request: Create a clean 16:9 landscape architecture infographic base explaining a research swarm and lazy research companion repository workflow. This will be post-processed with exact deterministic labels, so include absolutely no readable words, letters, numbers, pseudo-text, logos, or watermarks.
...
- Repository: `RESEARCH REPOSITORY`, `sase-org/sase--research`, `public linked companion`
