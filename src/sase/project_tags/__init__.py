...
from sase.project_tags.tags import (
    ...
    effective_find_vcs_workflow_tag_with_catalog as effective_find_vcs_workflow_tag_with_catalog,
    effective_vcs_workflow_tag as effective_vcs_workflow_tag,
    effective_vcs_workflow_tag_with_catalog as effective_vcs_workflow_tag_with_catalog,
