...
_confirm_launch = cli_work._confirm_launch
_expected_agent_names = cli_work._expected_agent_names
_find_beads_location = cli_common.find_beads_location
_find_live_name_collisions = cli_work._find_live_name_collisions
...
_print_work_plan_summary = cli_work._print_work_plan_summary
_resolve_changespec_launch_context = cli_work._resolve_changespec_launch_context
_rollback_work_launch = cli_work._rollback_work_launch
