#!/usr/bin/env python3
"""Standalone summarize-hook workflow runner for sase axe background execution (legacy quarantined copy).
...
Usage:
    python3 ax_summarize_hook_runner.py <changespec_name> <project_file> \
