...
def format_directive_arg(value: str) -> str:
...
def protect_ignored_regions(prompt: str) -> tuple[str, Callable[[str], str]]:
...
def rewrite_protected_prompt(
    ...
    *,
    ...
    if replacement is None:
        return cleaned
    return insert_directive(cleaned, replacement)
...
def find_alt_inner_regions(prompt: str) -> list[tuple[int, int]]:
...
def is_inside_regions(pos: int, regions: Iterable[tuple[int, int]]) -> bool:
...
def insert_directive(prompt: str, directive: str) -> str:
