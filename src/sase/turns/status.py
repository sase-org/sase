...
def clamp_turn_status_or_default(
    value: str | None,
    *,
    default: str,
    max_chars: int,
...
def turn_status_pair(
    ...
    *,
    ...
    max_chars: int,
    ellipsis: str,
    pair_type: type[TurnStatusPair] = TurnStatusPair,
    noun: str = "shell status",
) -> TurnStatusPair:
    """Clamp both pair halves, filling missing halves from defaults."""
    return pair_type(
        start=clamp_turn_status_or_default(
            start,
        ...
        stop=clamp_turn_status_or_default(
            stop,
...
def turn_status_style(
    ...
    *,
    ...
    accent = turn_status_accent(pair, accents=accents)
    if shell_state in settled_ok_states:
        return accent
    return f"bold {accent}"


def turn_status_glyph(
    shell_state: str | None,
    *,
