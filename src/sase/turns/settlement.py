...
def settle_turn_claim_and_followup(
    artifacts_dir: str,
    meta: dict[str, Any],
    *,
    shell_state: str,
...
def stamp_turn_finished_at(marker: MutableMapping[str, Any]) -> None:
...
def touch_turn_refresh_pulse(project_name: str | None) -> None:
