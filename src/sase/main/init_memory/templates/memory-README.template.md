...
- `sase/memory/sase.md` is always generated by SASE and captures linked repositories plus workspace rules. SASE-managed
  project repositories also generate `sase/memory/sase_artifacts.md` for artifact-reference guidance,
  `sase/memory/sase_beads.md` for shared bead workflow guidance, and `sase/memory/sase_sizes.md` for size guidance.
