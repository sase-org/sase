...
def register_agent_cli_parser(subparsers: argparse._SubParsersAction) -> None:
    ...
    agent_cli_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "a canonical documentation URL. SASE never runs sudo without a "
            "reviewed request, never uses a shell, never guesses an update "
            "command, and never edits your shell "
            "startup files.\n"
            "\n"
