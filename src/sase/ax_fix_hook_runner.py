#!/usr/bin/env python3
"""Standalone fix-hook workflow runner for sase axe background execution (legacy quarantined copy).
...
Usage:
    python3 ax_fix_hook_runner.py <changespec_name> <project_file> <hook_command> \
...
from sase.ax_runner_utils import finalize_axe_runner
