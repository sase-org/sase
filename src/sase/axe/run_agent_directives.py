...
def _apply_clan_launch_defaults(
    *,
    artifacts_dir: str,
    workspace_dir: str,
    ...
    if (
        ...
        and not _metadata_tribe(preserved_metadata, "clan_tribe")
        and not _metadata_tribe(agent_meta, "clan_tribe")
    ):
    ...
    if (
        ...
        or _metadata_tribe(preserved_metadata, "clan_summary")
        or _metadata_tribe(agent_meta, "clan_summary")
    ):
    ...
    if remembered_script or remembered_summary:
        tribe_for_script = _metadata_tribe(agent_meta, "clan_tribe")
