...
from .chop_runner_script_result_keys import release_unlaunched_once_per_keys
from .chop_runner_script_result_launch import launch_accepted_script_chop_proposals
...
def process_script_chop_result(
    *,
    ...
    return launch_accepted_script_chop_proposals(
        lumberjack_name=lumberjack_name,
        chop=chop,
        run_id=run_id,
        started_at=started_at,
        ...
        proposals=proposals,
        once_per_decisions=once_per.decisions,
        once_per_effective_waits=once_per.effective_waits,
        launch_plans=launch_plans,
