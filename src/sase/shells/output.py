"""Bounded streaming capture for supervised shell output."""

from __future__ import annotations

#: Retain at most this many bytes of output (head + tail).
SHELL_MAX_OUTPUT_BYTES = 2 * 1024 * 1024

_ELISION_TEMPLATE = "\n… {elided} bytes elided …\n"


class OutputCapture:
    """Retain a bounded in-memory view of a shell's bytes."""

    def __init__(
        self,
        *,
        max_bytes: int = SHELL_MAX_OUTPUT_BYTES,
    ) -> None:
...
__all__ = ["SHELL_MAX_OUTPUT_BYTES", "OutputCapture"]
