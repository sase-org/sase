...
## [0.18.0](https://github.com/sase-org/sase/compare/v0.17.1...v0.18.0) (2026-09-26)


### ⚠ BREAKING CHANGES

* **core:** sase now speaks fleet protocol 2 and fleet API wire schema 2, so a machine running an older sase gets a clean incompatible-protocol error until it upgrades. Session-member agent links, including commit footers, now point at `sessions/<global>.md` agents-sidecar pages.
* **agent-session:** family/kind:family aliases now normalize to session/kind:session; list/search/index/wait JSON emits agent_session/session kinds

### Features

* **ace-tui:** accept and preserve multiplier capacity in wait and directive editors ([2f88d1e](https://github.com/sase-org/sase/commit/2f88d1eaa7f34ddf03a6dd016d5487452abba064))
* **ace-tui:** add command-line completion popup phase sase-17x.9 ([d4dc96e](https://github.com/sase-org/sase/commit/d4dc96eb4a163f33c73d2e6a93c3731a227b2829))
* **ace-tui:** attach clan unknown-wait count inside the waiting chip ([8e82089](https://github.com/sase-org/sase/commit/8e82089e8b8ef127e40494ed45354ea67e42bb2a))
* **ace-tui:** block-spread and deck-spread navigation with ReadingAnchor (sase-19x.6) ([5f082a5](https://github.com/sase-org/sase/commit/5f082a5f13c84b5128d51992ff1696d1815a9c0d))
* **ace-tui:** card-block [ and ] keys with gating, footer, help and palette (sase-19x.7) ([972acbe](https://github.com/sase-org/sase/commit/972acbe9023cf20d1e0960f072f69d86f60ae4f8))
* **ace-tui:** deck node collapse and in-place zoom ([71fff39](https://github.com/sase-org/sase/commit/71fff39d1588bd96ded18c7f5b64c1ca9d63421e))
* **ace-tui:** keystroke paths use snapshot-only project-tag helpers phase sase-185.4 ([02dd052](https://github.com/sase-org/sase/commit/02dd0527f903203cfdb5e0fad18b0c2049068e07))
* **ace-tui:** label header usage cluster with dim usage: prefix ([4fb63b0](https://github.com/sase-org/sase/commit/4fb63b05a1e79e157fc1aac8463ebd1a9850ddad))
* **ace-tui:** merge monitor chip into procs indicator and add updates arrow ([bc1a9bf](https://github.com/sase-org/sase/commit/bc1a9bf1da0827e9b2aa4a18acfa8312c26e611e))
* **ace-tui:** one-row block rail under Main deck panel (sase-19x.8) ([f7df95c](https://github.com/sase-org/sase/commit/f7df95c94c0fc5a2498968ce46fec815444cd020))
* **ace-tui:** render loaded queue multipliers as authored capacity (sase-19f.6.4.1) ([d365706](https://github.com/sase-org/sase/commit/d36570629759384df88a0c3ef4c818cdfd7b8d88))
* **ace-tui:** render queue capacity multiplier end to end ([5f676a2](https://github.com/sase-org/sase/commit/5f676a28e8b3b3c9a7f3378200e448b60b75f9cd))
* **ace-tui:** render the collapsed header xprompt preview as an XPROMPT card ([0b70c2c](https://github.com/sase-org/sase/commit/0b70c2c3d37e8588e519de9e1739deb8e01ebc03))
* **ace-tui:** show a deck in the other panel from the deck picker capitals ([31a37bd](https://github.com/sase-org/sase/commit/31a37bd7b9b8e83dca71e29a04a84910ada6d866))
* **ace-tui:** wrap bead note previews to the visible Context-card width ([204a499](https://github.com/sase-org/sase/commit/204a4993e298717469eb318410e15bb2b878c2cd))
* **ace:** accept completion menus with ctrl-f ([307da2d](https://github.com/sase-org/sase/commit/307da2dacc1c5cfaf37c15cc69e4d60f1adf02fc))
* **ace:** accept prompt submits as pending launches (sase-185.1) ([8c4f3f8](https://github.com/sase-org/sase/commit/8c4f3f8094b9c8c968382ac4ce79e9d5cd788822))
* **ace:** add agent bead touches panel and sase context snapshots ([7211290](https://github.com/sase-org/sase/commit/72112905707800b3f51068d66edda19323d359ba))
* **ace:** add agent node finder modal with snapshot, preview and fuzzy model ([0b55415](https://github.com/sase-org/sase/commit/0b55415cd7e5178fc966b85c718ac5a7b015f8d4))
* **ace:** add AgentActionChooserModal single-keypress chooser with tests and PNG golden ([1b2f41d](https://github.com/sase-org/sase/commit/1b2f41d7dbd58ee7e4a28e411fa50ac3a19a88e1))
* **ace:** add Agents deck picker modal on pick_deck key ([ce1336e](https://github.com/sase-org/sase/commit/ce1336eec711d7db93878d75e38afcd32ce19af8))
* **ace:** add Agents jump-panel keymap phase with non-run toggle ([3408056](https://github.com/sase-org/sase/commit/34080568e6e9e91376eed89906eae3d99f24dd7b))
* **ace:** add clan sticky header with detached identity panel ([24d5e20](https://github.com/sase-org/sase/commit/24d5e20afb21c0d4c3b0baf477e5d19616210e05))
* **ace:** add hidden node finder reveal coverage ([aa5fc55](https://github.com/sase-org/sase/commit/aa5fc5503b05cea27667575a010889d65d1608ff))
* **ace:** add node identity jump ladder ([0854519](https://github.com/sase-org/sase/commit/085451924eaedf9c882d1a8e0f0ab4b64b74b5e9))
* **ace:** add provider-priority icon chip to top-bar indicator cluster ([c44f696](https://github.com/sase-org/sase/commit/c44f696184153010e0b4abab3460d40b10c6e06f))
* **ace:** add pure block cursor model and block spread config key ([465a885](https://github.com/sase-org/sase/commit/465a8858b99e2c9d5b978ceaac9003ca6030b5eb))
* **ace:** add pure xprompt header preview fitting and header settings (sase-18g.1) ([67b1b6c](https://github.com/sase-org/sase/commit/67b1b6c5a88fd973812adc2f537038a535d16715))
* **ace:** add the Agents-tab Node Finder modal ([89ebc76](https://github.com/sase-org/sase/commit/89ebc76256aeefdb28c1e1acfc05469ecfe32cb6))
* **ace:** add tribe CLAN SUMMARIES section with worker-side digests ([e1c4208](https://github.com/sase-org/sase/commit/e1c4208cd23f8b5561d5ac96386e23d6d6ef5afd))
* **ace:** add tribe panel PROMPTS intent map ([c6c70be](https://github.com/sase-org/sase/commit/c6c70befc7b2a3d835eb7036dbc4ab48f5c8ef45))
* **ace:** agent and file context queries plus Agents-tab reveal ([60b236b](https://github.com/sase-org/sase/commit/60b236b5b3d5ed591d986410da68cc6351ffc4ac))
* **ace:** Agents-tab A toggles bare %auto instead of opening the Auto-Approve menu ([651a32e](https://github.com/sase-org/sase/commit/651a32ee00fb2302b34c8de11c1aeda1a98649c6))
* **ace:** agents-tab panel focus follows the selection on refresh ([04d3584](https://github.com/sase-org/sase/commit/04d35849d1b4d957af7c01ea07a0a0f4a91ed5ff))
* **ace:** allow forking finished planner agents ([0d7229b](https://github.com/sase-org/sase/commit/0d7229bef1400d66845279d68e5c63d748906218))
* **ace:** bounded-panes acquire-then-reveal for Stitch, Plan/provider, and Patch jumps ([a74e98c](https://github.com/sase-org/sase/commit/a74e98cfb769e215d32ee5ed915d2683e5b59228))
* **ace:** cap collapsed agent header xprompt preview at 3 rows ([04cf2b1](https://github.com/sase-org/sase/commit/04cf2b176580299ef6b57a98826731f91cbdba65))
* **ace:** collapsed header shows xprompt preview rows with budget and overflow ([4858f20](https://github.com/sase-org/sase/commit/4858f20a2d0016b21e78558c433854112108de2c))
* **ace:** command-line completion extras for sase-17x.10 ([c03c717](https://github.com/sase-org/sase/commit/c03c717daebb74852c9c1f329e7aabd866cc2741))
* **ace:** command-line run policies, confirmation-aware blocks, and built-ins (sase-17x.11) ([ee9eda4](https://github.com/sase-org/sase/commit/ee9eda4ab340bf9f6aaac08a773ca39dd912f93f))
* **ace:** command-line transcript blocks with NORMAL-mode navigation ([98c8312](https://github.com/sase-org/sase/commit/98c8312f96f6b8f50303f7d6b6106c31a6afd03b))
* **ace:** complete agent session terminology ([cdf4912](https://github.com/sase-org/sase/commit/cdf491254c6f8198b8f9b95e15c5f6239ce520ae))
* **ace:** detach accepted agent launch guards ([93d8d41](https://github.com/sase-org/sase/commit/93d8d4140cea62629942839fa9eee8c962fcf5a0))
* **ace:** detach agent xprompts into identity headers ([4af219e](https://github.com/sase-org/sase/commit/4af219ebae29fdc28715fbf7ecd9dbc1efccc9ad))
* **ace:** detach dispatch source preflight (sase-185.3) ([a21985b](https://github.com/sase-org/sase/commit/a21985b88fe2de892bb221d3a5ab4fa1cec285b7))
* **ace:** drop redundant rejection marker from exact-0% usage badges ([6561928](https://github.com/sase-org/sase/commit/6561928db8a2c512890d29d3711f688b48e5e298))
* **ace:** flip command-line and palette keys to colon and semicolon ([c83e3bd](https://github.com/sase-org/sase/commit/c83e3bd916be309d8ffc9e4bc0b258131ea1d253))
* **ace:** fuse per-open Node Finder snapshot facets (sase-19i.7.3.1) ([d1b72cf](https://github.com/sase-org/sase/commit/d1b72cfe58e815deafe4e7c72c4774b487346efd))
* **ace:** give the top-bar updates badge its own visual language ([ecf795f](https://github.com/sase-org/sase/commit/ecf795f5a37a41f17178a152120f4b039b5791be))
* **ace:** give the top-bar updates badge its own visual language ([0247b65](https://github.com/sase-org/sase/commit/0247b657d0dd0b79d8c1f9f9cda43b50b304abe3))
* **ace:** hide idle dispatch Target/Source context line without %dispatch ([07d1c0e](https://github.com/sase-org/sase/commit/07d1c0e7b2f951ba363d6dee1e3315948611c9e8))
* **ace:** implement Command Line panel shell behind ace_command_line beta flag ([db99493](https://github.com/sase-org/sase/commit/db99493448ff762695410f6d06e42164707572d8))
* **ace:** implement deck splits focus layout state machine ([075225d](https://github.com/sase-org/sase/commit/075225d53795b20eb18dd4a8f32a421ebaa8caad))
* **ace:** implement deck spread versus paged rendering (sase-17d.8) ([329d404](https://github.com/sase-org/sase/commit/329d4049b6f61467f5a97006346f0b487b994ee8))
* **ace:** implement Updates-tab agent-CLI install flow ([02cd6b6](https://github.com/sase-org/sase/commit/02cd6b69ee2b587e118482877d6719bebb8eda31))
* **ace:** keep prompt stash panel open after partial delete ([abfd74d](https://github.com/sase-org/sase/commit/abfd74d17320f24468a4912b8e57569185328755))
* **ace:** labeled dot-separated top-bar indicator cluster ([f4d70c4](https://github.com/sase-org/sase/commit/f4d70c452b5cd668cb637b73422f7a0dfa4999d8))
* **ace:** labeled launch-context cluster on every tab's status row ([dd1d49b](https://github.com/sase-org/sase/commit/dd1d49bf5021aa2274e33add9d94348f44b2755a))
* **ace:** lowercase launch-context labels to model:/project: ([215f1cd](https://github.com/sase-org/sase/commit/215f1cd26774e2d70e6234c9d7fb2dc03b6c3241))
* **ace:** make Agents Enter context-aware via act_on_agent ([b27029e](https://github.com/sase-org/sase/commit/b27029e894a0176f213c3915ddfc8b003acfed9a))
* **ace:** move numbered roster sections into Agents jump panel ([78f1d71](https://github.com/sase-org/sase/commit/78f1d71e79450382b6b71b7fe9863600c1b02760))
* **ace:** move repeat-last VCS xprompt from Ctrl+Space to Space, remove run-agent-home ([3844ed8](https://github.com/sase-org/sase/commit/3844ed83d8cd452eac309773acf21abfa481035c))
* **ace:** one engine for every jump, plus the end-to-end matrix ([e3c2a77](https://github.com/sase-org/sase/commit/e3c2a7788b83873dc1cdf5e8ca4da5bb381a7b04))
* **ace:** open effort completion on @ after %m:&lt;model&gt; space ([740c08f](https://github.com/sase-org/sase/commit/740c08f6183175ec46b6d2fdbfbfe229ae16f22a))
* **ace:** open Updates tab from cache, refresh only on r ([b69c86a](https://github.com/sase-org/sase/commit/b69c86a0402495e2e81ad91b54f7cad46a3a10f9))
* **ace:** plan-then-commit link reveal engine with Beads context queries ([56a7684](https://github.com/sase-org/sase/commit/56a7684a3e3b3572ccaf206a7876941a75aa4331))
* **ace:** polish Agents status row with dot grammar, refresh countdown, and load gauge ([d60464c](https://github.com/sase-org/sase/commit/d60464c61359fd9ccd6ea97b22f39ba03ae68bf2))
* **ace:** preview agent bead notes ([43f7246](https://github.com/sase-org/sase/commit/43f724619f2ea828ac0eb6d123f01f80251a917d))
* **ace:** remove Agents-tab tilde neighbor keymap ([184241f](https://github.com/sase-org/sase/commit/184241fa6635a1bd3ff2e2e793147ebbb7407099))
* **ace:** remove legacy agents UI ([742c1df](https://github.com/sase-org/sase/commit/742c1df38b04d1b190a5102168f0cf2ab37e6840))
* **ace:** rename family prompt panels to sessions ([b79b9da](https://github.com/sase-org/sase/commit/b79b9da246b434897fad03229097f76be34a7848))
* **ace:** rename launch-context labels default/current to MODEL:/PROJECT: ([2c59bd9](https://github.com/sase-org/sase/commit/2c59bd9b75dd599a28496a6cb9f6376d0eb6a67e))
* **ace:** retarget agents detail actions to focused deck panel ([7d22725](https://github.com/sase-org/sase/commit/7d2272588839582b01bcdeb789a26708ed0f1b8d))
* **ace:** reveal toast, lens chip label, and Link Jumps docs ([e25372a](https://github.com/sase-org/sase/commit/e25372a64a856b692329c9ad57f935a945f58ad2))
* **ace:** route bead hints to pager live detail with copy support ([77e0cfb](https://github.com/sase-org/sase/commit/77e0cfb6c043a1da3efc4c164d9ea328cbe50b77))
* **ace:** show Agents fleet header row only for actionable problems ([c77feeb](https://github.com/sase-org/sase/commit/c77feebaa1152ad59e96c6efbbaef883c53769bf))
* **ace:** show green update gear while SASE is updating ([0f65d54](https://github.com/sase-org/sase/commit/0f65d549f9672a27558a3b41900bbaa9c8bb6f98))
* **ace:** sticky collapsible jump footer panel on the Agents tab ([311e761](https://github.com/sase-org/sase/commit/311e761145e56aa22b2b4eaa030afd3ebd704932))
* **ace:** tolerate new agent-session spelling in directive contract and completion ([a764a76](https://github.com/sase-org/sase/commit/a764a76d41fbcacfe08ecbf93a351d3c53d732ad))
* **ace:** vim operator + search motions in the prompt input ([8d1779a](https://github.com/sase-org/sase/commit/8d1779a3efb34bc33db2373d7f82e9ad94d3be7a))
* **ace:** x stops every member kind instead of skipping it (sase-18d.4) ([3cf0f1f](https://github.com/sase-org/sase/commit/3cf0f1ff68ab3f89233defdf3fc1ec9e5088161d))
* Add Grok 4.7 support ([1cea18e](https://github.com/sase-org/sase/commit/1cea18e00fd2ca84ef6bcd69589cf161fc974f0b))
* **agent-cli:** shared installer learns npm-packaged CLIs ([bc128b6](https://github.com/sase-org/sase/commit/bc128b655a563be39596a0a3b0d6ec746181458d))
* **agent-session:** canonical session query dialect with JSON kinds ([3a1d0ba](https://github.com/sase-org/sase/commit/3a1d0bab282a5d796d9b2d8f45ab4a65c96f4091))
* **agents-finder:** wire quotation_mark to jump_to_node with goldens and bench ([df0d58d](https://github.com/sase-org/sase/commit/df0d58d337f06b8e20878ebc0734a6309041c647))
* **agents-sync:** publish sidecar session pages and bump core pin ([7cb8359](https://github.com/sase-org/sase/commit/7cb8359534d90a04aa09d012bc4c6b2190cb2ce9))
* **agents-tab:** card-partitioned Main documents ([9abf08b](https://github.com/sase-org/sase/commit/9abf08b5df74ebc17f5e293e4909702867105880))
* **agents-tui:** deck panel core behind the agent_decks beta flag ([00ee519](https://github.com/sase-org/sase/commit/00ee51996d109f2715701b4140f7b528520764de))
* **agents:** add inert toggle_agent_header keymap plumbing ([9aa46d0](https://github.com/sase-org/sase/commit/9aa46d006734b2fbbdf49ff2fc1074e209860775))
* **agents:** bracket filter counts and add edit-query key hint ([2232480](https://github.com/sase-org/sase/commit/2232480131b7f8b834e0284dd33128865461b967))
* **agents:** detachable identity header in prompt-panel documents ([2822794](https://github.com/sase-org/sase/commit/28227947e135f66042f61aa3fac9428d1defad6e))
* **agents:** jump-map sections, document carrier, and pure legend renderer ([0513bf2](https://github.com/sase-org/sase/commit/0513bf2ab3048cd8b6c07c1041fe9856b33e142b))
* **agents:** keep sticky agent header visible in file/LLM Calls-only layout ([8c89951](https://github.com/sase-org/sase/commit/8c89951644a32818908645aa7bd26dd264d48974))
* **agents:** never fold jump panel neighbors out ([8eb0c63](https://github.com/sase-org/sase/commit/8eb0c6308e6af2e425a56c42c221818d1a2b3671))
* **agents:** persist deck layout across restarts ([4388817](https://github.com/sase-org/sase/commit/43888178618aa31fb531a3d02e0ffb4fe6839dc7))
* **agents:** same-tick unread marker for completed agents ([126dd63](https://github.com/sase-org/sase/commit/126dd63c0a0f1fd2707da177cb96505100076983))
* **agents:** scroll expanded sticky header with Ctrl+D/U ([78ba932](https://github.com/sase-org/sase/commit/78ba93207414257e21dc133a05af62113f4a83ea))
* **agents:** sticky collapsible agent header panel on Agents tab ([7c2e051](https://github.com/sase-org/sase/commit/7c2e051479e6b72789f33063ecd1e476278133af))
* **agents:** validate archive objects ([4214ccc](https://github.com/sase-org/sase/commit/4214ccc650b63c2efb7839af46ddb966d788ca1d))
* **agent:** verified process-tree termination in the durable cleanup proc (sase-18d.3) ([b7cfa06](https://github.com/sase-org/sase/commit/b7cfa069cb45b421f4abc87ddb8b21bb15d71c05))
* **agy:** hardened usage collector, provider hooks, fixture, tests, docs (interim; verification pending build) ([8e0f38a](https://github.com/sase-org/sase/commit/8e0f38a532354685635d6534fd351b8c189ce100))
* **agy:** header naming polish, default config, and snapshots ([80c0f54](https://github.com/sase-org/sase/commit/80c0f549e4dba7467756f2827c05940b82f9b3e5))
* **axe:** add source-based Services nav panels ([880f1f8](https://github.com/sase-org/sase/commit/880f1f863e824f1009217e782deef7ec4b58c5ab))
* **axe:** calm dense builtin navigation with health badges and first-sight folding ([bd83d3e](https://github.com/sase-org/sase/commit/bd83d3e6075770b58fd46d0c1e088fbde74bbced))
* **axe:** expose routine declaring source through config, CLI, and Services ([6f18d28](https://github.com/sase-org/sase/commit/6f18d282928335b49ab9000a7fa38c2a4f62a927))
* **axe:** preserve launch handoffs across post-wait runner refresh ([1567269](https://github.com/sase-org/sase/commit/1567269ca737c9949f0692c54a78cc48cb461d93))
* **axe:** re-create managed workspace with reclone on preparation failure ([505934a](https://github.com/sase-org/sase/commit/505934a639b318b995bab43a98925e67150e4705))
* **axe:** two-panel Services sidebar with titled panels ([3f5d34e](https://github.com/sase-org/sase/commit/3f5d34e9fde31be2c0a8cc393f1db464e2cfa14d))
* **bead:** automatic recovery for approved-plan epic launches (sase-17y.3) ([edfa80f](https://github.com/sase-org/sase/commit/edfa80f0ba395170a102eabff8e14a1fd9361202))
* **bead:** launch-guard for relocated epic/task graphs ([2d6a57b](https://github.com/sase-org/sase/commit/2d6a57b3fcf8e349eb243e4f3dead5de50b52e7e))
* **bead:** refuse agent bead show with read/view/query guard ([d6a64c6](https://github.com/sase-org/sase/commit/d6a64c6b682107714be1844cfdd719487d8d11ca))
* **bead:** refuse closing a flag bead while its registry definition survives ([fdc3e3c](https://github.com/sase-org/sase/commit/fdc3e3caf65d7d6a56ae0499dd11fac92efd8066))
* **beads:** add audited sase bead read with visible read reasons ([0b30610](https://github.com/sase-org/sase/commit/0b30610471a5f205b8bf7c951bf78236a7cec193))
* **beads:** bead sync rollback and wedged-clone healing ([ce730ca](https://github.com/sase-org/sase/commit/ce730ca1b38f63fb90daaf8584625aad2dc20f69))
* **beads:** land sase bead touched with panel-agreeing rows, core pin, and Beads goldens ([319fe6b](https://github.com/sase-org/sase/commit/319fe6b246fa09f4c8fa509a98f4a8b9e4c9f10f))
* **beads:** record agent bead show views as weaker viewed touches ([da766b8](https://github.com/sase-org/sase/commit/da766b87a17b6fdbb1402fef50b4d28fc460e44c))
* **bead:** surface agent close records through Python plumbing ([ed548d3](https://github.com/sase-org/sase/commit/ed548d3e26ca95ef01dda40d2488ff21529cb974))
* **cache:** cache xprompt lsp build artifacts ([adebe40](https://github.com/sase-org/sase/commit/adebe400d76371385f420710df6608ec219e8aab))
* **chat-restart:** route chat-install recovery through scheduler service host ([62c902f](https://github.com/sase-org/sase/commit/62c902f0deccaead6b32de6a88fef9bc83e37aa5))
* **clans:** clan-level tribe edits from the Agents tab ([372135a](https://github.com/sase-org/sase/commit/372135af742b8ec04e08ce47781a94de289ae3eb))
* **clans:** inherit remembered tribe and summary for new clan generations ([1fb9d01](https://github.com/sase-org/sase/commit/1fb9d01385cbe420eaed7e3c341eb921ca178ba4))
* **clans:** record, capture, and read clan attributes from sase ([69a5ca5](https://github.com/sase-org/sase/commit/69a5ca5e1d0d059f7a0c613526d6990629c045ae))
* **cleanup:** carry runner_is_live on wire v5 with FAILED+live kill rule ([e3f3a4b](https://github.com/sase-org/sase/commit/e3f3a4bd4010d3ca892d9b2e7c49dec19e77e3ff))
* **cli:** add shared stdout color contract honoring FORCE_COLOR ([5a79551](https://github.com/sase-org/sase/commit/5a7955161e960662c41fa496ab5ef699941e3cb1))
* **cmdline:** command-line proc plumbing (sase-17x.6) ([70afac5](https://github.com/sase-org/sase/commit/70afac5176b90b4c7cad6590b4199ad295fc14cb))
* **command-line:** add completion goldens and perf probe ([3c6e8f0](https://github.com/sase-org/sase/commit/3c6e8f04dcdbd0806909d519ef3c661efbfde87a))
* **command-line:** add dynamic completion sources ([fad9b5d](https://github.com/sase-org/sase/commit/fad9b5d03db1b2812dcd10576d1eeefe4aec3de4))
* **command-line:** apply the ace.keymaps.command_line scope ([bde335d](https://github.com/sase-org/sase/commit/bde335de55acb2d17ce120213046d2f26fd33e19))
* **command-line:** border chrome and floating popup (sase-17x.13.8) ([403586e](https://github.com/sase-org/sase/commit/403586e27127f4a0afd6479416957b13de1bc3dd))
* **command-line:** CommandLineGrammar resolver adapter and contract test ([ede63ea](https://github.com/sase-org/sase/commit/ede63ea9dcec4672873412d9f5d4d3f65f72ffcf))
* **command-line:** complete key behavior contract ([543d012](https://github.com/sase-org/sase/commit/543d012209875d59081f8c4d908168c6687ac4e9))
* **command-line:** foreground interpreter, writes chips, and UI-thread I/O (sase-17x.13.7) ([5b305b1](https://github.com/sase-org/sase/commit/5b305b1b95c4e6d21ddb8fbf8982dafb7f8c13f1))
* **completion:** add GATE, TOOL_RUN, TASK_TYPE kinds with entity candidates and kind-coverage ratchet ([79a16ca](https://github.com/sase-org/sase/commit/79a16ca7712fca793714e92d9c884aca86da1fc5))
* **completion:** Command Line spec contract (sase-17x.2) ([db4266e](https://github.com/sase-org/sase/commit/db4266e1cd1c853bfe3a176a053ef2aa0c80dbde))
* **completion:** TAB completion for pending plan names ([482fb46](https://github.com/sase-org/sase/commit/482fb46bcc02044219d3723f1b215d76baaa7642))
* **config:** add managed_tmp.agent_cargo_incremental opt-in for agent cargo incremental ([e081abe](https://github.com/sase-org/sase/commit/e081abe1cb9168a20b9ff5a989956d0beb1d96c8))
* **decks:** add CardBlock data model, walkers and block anchors ([671a611](https://github.com/sase-org/sase/commit/671a6116c5d7ae9f5567497538dbac4bceffc084))
* **decks:** block-paged projection with newest landing and card_blocks flag (sase-19x.5) ([42e29d6](https://github.com/sase-org/sase/commit/42e29d6ccca3bf8f2de51a020526f464f5a021d5))
* **dev-update:** add line-streaming subprocess runner with on_output sink ([94ccd19](https://github.com/sase-org/sase/commit/94ccd19176a50586b97c2f8add0d431d1097ed18))
* **dev-update:** instrument plan, execute, reconcile and mode-switch backends with progress events ([5a89392](https://github.com/sase-org/sase/commit/5a89392fe0fbfc59052b47257b9a882345c3302a))
* **dev:** rebuild extension when linked sase-core source changes ([e8d2386](https://github.com/sase-org/sase/commit/e8d238688ff9b75edec510d3a8b56aec9e6c77d9))
* **dismissed-index:** persist dismissals additively for every writer ([1ea13da](https://github.com/sase-org/sase/commit/1ea13da1b3450d2c89da83beb47814f117e9315b))
* eplace stale model and pool enumerations with generated-table links (sase-1aa.5.2) ([ec25a1a](https://github.com/sase-org/sase/commit/ec25a1a3338edf683336138a6e6819f7a5906ffa))
* **finalizers:** guard the raw-submit fallback (sase-196.5) ([7d14286](https://github.com/sase-org/sase/commit/7d14286e594de40c34f891d54eccbaacbe19d8d4))
* **history:** seed Ctrl+K project scope from +project tags ([b3e31bb](https://github.com/sase-org/sase/commit/b3e31bb592da4cc2f7d5e957cfab2e307eaee08b))
* **just:** drop toobig from check and check-full ([951ff0a](https://github.com/sase-org/sase/commit/951ff0a102256a591fa3240f14ec88e39419b125))
* **lease:** retry transient git fetch failures during operational lease preparation ([77f869c](https://github.com/sase-org/sase/commit/77f869cb18d74f4fd712e79f4f882a07e45ea5ec))
* **legacy-reply:** per-phase blocks for followup_agents Reply path (sase-19x.4) ([6bfd710](https://github.com/sase-org/sase/commit/6bfd7103dc6efaced71e909c111515e89ea2e3ee))
* **llm-provider:** add CLI capability cache for usage probes ([5e50d27](https://github.com/sase-org/sase/commit/5e50d27f599b8b5e5e63376bbcf216825ae32331))
* **llm-provider:** add executable model policy over models.yml ([e2b4625](https://github.com/sase-org/sase/commit/e2b462548c2becdf846ed2773450c4542b56de04))
* **llm-provider:** add Muse wait-claim continuation guard ([eda6741](https://github.com/sase-org/sase/commit/eda67411640ea58995921352f54af9e3b454f5a5))
* **llm-provider:** capture Muse shell tool calls and map timeout outcomes to failure ([a0368d5](https://github.com/sase-org/sase/commit/a0368d54f1fb99e55bb261b785b67751777544a8))
* **llm-provider:** dedicated usage scheduler routine that probes inline ([a6e2758](https://github.com/sase-org/sase/commit/a6e27583c848ef087636e9f4fca1f2bd027c6bda))
* **llm-provider:** hot cadence for providers in active use ([1f75302](https://github.com/sase-org/sase/commit/1f753027252a7ed5332871f8430d86693c30f5e8))
* **llm-provider:** move built-in model data and size aliases into one manifest ([1ef56bd](https://github.com/sase-org/sase/commit/1ef56bd1b696af2de86705af38c1c7321686926f))
* **llm-provider:** plugin polling floors, CLI fingerprints, and mark-only limit events ([fcce8f2](https://github.com/sase-org/sase/commit/fcce8f2f336199f4db80088c7a02531c34f66128))
* **llm-provider:** rate-limit classification and reason-aware attempt plumbing ([ed8172f](https://github.com/sase-org/sase/commit/ed8172fdabebbc60bbe29df9473ea899129de4a7))
* **llm:** generate model docs tables with policy gate and doctor check ([39acc57](https://github.com/sase-org/sase/commit/39acc575475bf2d0391b24a655d2077c6a86b0e6))
* **llm:** select GPT-6 Luna for smaller Codex size aliases ([4ee966c](https://github.com/sase-org/sase/commit/4ee966cd56b9db4020c9b859738456948afec75c))
* **memory:** add Agent Relation Jump Target glossary strand ([9839653](https://github.com/sase-org/sase/commit/9839653612ccfba08a171d242f72a93fdd35adb3))
* **memory:** restore Agents-only node and add nav section/item glossary terms ([7e99aad](https://github.com/sase-org/sase/commit/7e99aad4528259f0ebacbd979c50db026d8cdb19))
* **models:** add GPT-6 Sol selection and make it the Sol default ([682089c](https://github.com/sase-org/sase/commit/682089c845f29055ef21d1f5b535bee13bbc822e))
* **monitor:** make in-agent sase monitor start fast and never silent (sase-18e.2) ([c9da1f1](https://github.com/sase-org/sase/commit/c9da1f164786b5a94700124bbfb33d806f133b67))
* **monitor:** pin sase-core past agent_session filter and fix symvision survivors ([4fb83bb](https://github.com/sase-org/sase/commit/4fb83bb4faa269b8e43db21695879c34072c77de))
* **monitor:** record and surface killed handoffs (sase-18e.3) ([db33796](https://github.com/sase-org/sase/commit/db337969b904f1ef1814090d68d328c8b8d99daa))
* **monitor:** reserve ToolRun hand-off on monitor start (sase-17p.3) ([7f450e0](https://github.com/sase-org/sase/commit/7f450e0112d43136cf19afde6053979747c43439))
* **monitor:** wrap supervised commands in sase tool run ([6167ec4](https://github.com/sase-org/sase/commit/6167ec42cb1df33bb670ddf3d9c81ea75303a9c2))
* **muse:** run synchronously behind muse_synchronous_shell sunset flag ([28b3c1b](https://github.com/sase-org/sase/commit/28b3c1bab27cdbbc6f1ea99c4f5afbebcbd003a4))
* **node-finder:** add row model, snapshot, filtering, and hints (sase-19i.1) ([ee22eb3](https://github.com/sase-org/sase/commit/ee22eb305c7c19eb960a1569286025d5434efe27))
* **notifications:** add dismissed view toggle and undismiss restore ([a8bd795](https://github.com/sase-org/sase/commit/a8bd795be2b80c08bfd13c098d05e8d8c3b74e2a))
* **ownership:** scrub executor ownership env at agent-launch boundaries ([b33732a](https://github.com/sase-org/sase/commit/b33732a41d3b981e515c5db06cc57e2382ad526d))
* **plan:** approve gateless plans from CLI ([e5c80e5](https://github.com/sase-org/sase/commit/e5c80e5ad1a61ab7cb4f87ffe054d78c9bc9c16d))
* **plan:** gate-owned pending visibility and name-first selector resolver (sase-17z.1) ([2bdd70c](https://github.com/sase-org/sase/commit/2bdd70c2d5d7c5fd09e2a23e32fce53a47512e28))
* **plan:** implement direct approval engine for gateless tales ([4d0ad9b](https://github.com/sase-org/sase/commit/4d0ad9ba5da30f3a5917fb67f4e23cb110219346))
* **plan:** names everywhere plans are listed (sase-17z.3) ([c3a61ae](https://github.com/sase-org/sase/commit/c3a61ae7d9e178ef1ec4758b808191ea50c54a93))
* **plan:** recover failed coder on re-approval of approved plan ([afaafd7](https://github.com/sase-org/sase/commit/afaafd73804a18b48c5c7b6016f360a02d2d0dcc))
* **plugins-browser:** add Available scope, mark-all toggle, and cross-scope filter hint ([2f89266](https://github.com/sase-org/sase/commit/2f892663858debbb0bc0b6befd62ddc11f6cb918))
* **preview:** content-aware sizing for the prompt preview panel ([f330e2b](https://github.com/sase-org/sase/commit/f330e2b949b5e9744213dd48d7c785cab29b3de1))
* **project-tags:** accent-colored project tags on raw-prompt surfaces ([3bf3b99](https://github.com/sase-org/sase/commit/3bf3b998abad35250e7a71de91e44780f2a517b5))
* **project-tags:** CLI and cold-TUI tag rendering, pager, MRU label, and red tests ([b924b03](https://github.com/sase-org/sase/commit/b924b03508978a7f28e50bd517ecca58e499a846))
* **project-tags:** Python tag backend fixes and step-8 launch tests ([394a53b](https://github.com/sase-org/sase/commit/394a53b6dfc5ee436073203fe71cb958d6b039e4))
* **projects:** enforce case-insensitive project name uniqueness ([dc08f7b](https://github.com/sase-org/sase/commit/dc08f7b21c31dd51853184a8607ed40c598beded))
* **providers:** render Grok/xAI badge as rocket instead of satellite ([21c7d00](https://github.com/sase-org/sase/commit/21c7d0033f7cd30678d0c8f64937f5b9796d92e0))
* Python runtime honors explicit zero weight (sase-198.2) ([4e18680](https://github.com/sase-org/sase/commit/4e18680d3d98c3d82cef1b026edd9bf9b3590bf9))
* **query:** wildcard parity, pin bump, pushdown guard, and docs (sase-16t.2, verification pending) ([f37f1dd](https://github.com/sase-org/sase/commit/f37f1dd480202d5eeead8aa04f8b0808504b8613))
* **queue:** allow zero-load agents with %queue(weight=0) (sase-198.3) ([0607f7a](https://github.com/sase-org/sase/commit/0607f7a083d80a96d3b1e9e0b5d6174417a6ce4e))
* **reaper:** capture SASE_TMPDIR in service env and warn on managed-root mismatch ([529d7d3](https://github.com/sase-org/sase/commit/529d7d325f050dc8af08d55d49e8251df4492160))
* Regenerate epic goldens and take the live walkthrough (sase-17x.13.10.6) ([9518b31](https://github.com/sase-org/sase/commit/9518b31df9b7e235170018fdc0dd6d53702275e1))
* Replace shipped-value copies in tests and guard the existing generated alias table ([b1d6f24](https://github.com/sase-org/sase/commit/b1d6f245222959ac860780e9f2b7519087221de4))
* **repo-open:** name opened repo AGENTS.md on stderr and fix core memory pointer ([772f3f1](https://github.com/sase-org/sase/commit/772f3f199621b901c1456a9c9d71d0d05bd766a2))
* **sase-16z.9.3:** floor-aware freshness for the TUI header usage indicator ([ee6f7c0](https://github.com/sase-org/sase/commit/ee6f7c0647ca8ebd4e008c16dd2599206be16f81))
* **sase-17x.4:** command-line proc tag and retention bucket in sase ([f6e17fb](https://github.com/sase-org/sase/commit/f6e17fb2c9adfbc82c4c1c726867b9026a512450))
* **scheduler:** escape detached runners from the service cgroup via detach_scope ([213c481](https://github.com/sase-org/sase/commit/213c481363af70deba92ee0c0dc3ee8e0c97b37c))
* **scope:** describe the completed work ([ea130c6](https://github.com/sase-org/sase/commit/ea130c678afbe48d0249d00311d2e4af0a5ddbf7))
* **scope:** describe the completed work ([1230ed8](https://github.com/sase-org/sase/commit/1230ed8da198e5952221819caf5e7962f9dec37c))
* **scope:** describe the completed work ([1c4ebe7](https://github.com/sase-org/sase/commit/1c4ebe76ad29aaeb1094a182dcec26406d14be70))
* **screenshots:** per-golden agreement voting over bounded serial re-verification ([716291a](https://github.com/sase-org/sase/commit/716291a9fdb3601c10c9519a77e53b760f2bc1b6))
* **screenshots:** salvage per-node captures with recovery retries and partial apply ([7f01925](https://github.com/sase-org/sase/commit/7f019258b1bfa1523786632d0f85d2b4bab12cf6))
* **service:** CLI and Services tab show real failure states ([c1af4a8](https://github.com/sase-org/sase/commit/c1af4a828178f0c820fe5ffa537e10b51184ca29))
* **service:** honor give_up with parked records and loud failure notifications ([716c77d](https://github.com/sase-org/sase/commit/716c77dce324cb2ef6f36990efaf8a0a416c397b))
* **service:** last-known-good config keeps the host supervising ([5374c03](https://github.com/sase-org/sase/commit/5374c03ab7b55c3843feef112df9c407495d941a))
* **service:** make captured service environment context-safe ([2ce4998](https://github.com/sase-org/sase/commit/2ce4998e9a164ccc6230df199e4e6b8ee4e7d809))
* **service:** restarts are confirmed generation transitions with honest CLI outcomes ([00106bb](https://github.com/sase-org/sase/commit/00106bbef8f03681669461e543f614afd8e43f0c))
* **services:** J/K panel jumps on the Services tab ([37bf264](https://github.com/sase-org/sase/commit/37bf264296e6fe2aa2c6c80479c2a0d218c5572c))
* **services:** sticky collapsible description header for service proc rows ([e80b948](https://github.com/sase-org/sase/commit/e80b948c3e92c52a327e96a019895bdee0f92860))
* Session Reply cards emit one block per sase shell (sase-19x.3) ([8f6257d](https://github.com/sase-org/sase/commit/8f6257d2184a94796da21426ac59f6835234e95f))
* **tool:** add hand-off adapters, contract probes, and finish diagnostics ([b6b9f4f](https://github.com/sase-org/sase/commit/b6b9f4f59b900f74edbcd0bbea2f704c2659a128))
* **tool:** add hermetic-baseline lint version probes and KNOWN precision recheck ([0b5fc65](https://github.com/sase-org/sase/commit/0b5fc652b0933891525879b16e16259969d90052))
* **tool:** add opt-in stage continuation ([eb64073](https://github.com/sase-org/sase/commit/eb640735540d73d728e31ecfb1323fe09ba84dd4))
* **tool:** add receipt execution CLI with settle adapter and receipt query ([2811476](https://github.com/sase-org/sase/commit/281147666b7ce353cb46fc1031870e72c9c7cd6d))
* **tool:** add receipts opportunity report for content-equivalent repeats ([473871c](https://github.com/sase-org/sase/commit/473871ceea6b68748793875bca1daef39ca68558))
* **tool:** add sase tool failures and follow-up triage ([89868a9](https://github.com/sase-org/sase/commit/89868a90b2e48eae1de60c8d24ce35682bbe46fc))
* **tool:** add tool_run_observe adapter, smoke round trip, and symvision epic whitelist ([d163dfa](https://github.com/sase-org/sase/commit/d163dfa2b6db768a04a7814d1bb306c121fd8736))
* **tool:** add triage input backtest ([cdcbcdd](https://github.com/sase-org/sase/commit/cdcbcdd9d3988359f1b4fc77d6d0454632a4e760))
* **tool:** finalize failure triage ([49c32e1](https://github.com/sase-org/sase/commit/49c32e19ec698c6c305ca374ee49421668f04215))
* **tool:** known-gated continuation for agent runs ([d17a753](https://github.com/sase-org/sase/commit/d17a7534ad595b45e7076755e0ddd84c1d378460))
* **tool:** pin receipt-capable core and adopt catalog receipt policy ([4e85d4b](https://github.com/sase-org/sase/commit/4e85d4bc0553290c9edfd2af1ec22d5922d6c885))
* **tool:** prove hand-off contract end to end and remove tool_handoff flag (sase-17p.6) ([c91690e](https://github.com/sase-org/sase/commit/c91690efcbae1179773f70a2823e77fabac4b203))
* **tool:** refuse raw agent runs of guarded check recipes ([7fad339](https://github.com/sase-org/sase/commit/7fad3394ca04d16d0331755ffd70b64c3fc362b8))
* **tool:** render settled failure triage ([71b25fb](https://github.com/sase-org/sase/commit/71b25fbf4eb20f3e184f25104307e20cc5488515))
* **tool:** settle hand-off ToolRuns from owner facts and deliver once (sase-17p.5) ([7173669](https://github.com/sase-org/sase/commit/71736697dcb97b14cceb96cf687dfa24d6454d17))
* **tool:** standalone hand-off of ToolRun via sase tool run -H ([c0591ad](https://github.com/sase-org/sase/commit/c0591adf203646bbe36a723a5592b0d4275c6863))
* **tool:** stop, follow, and wait on a ToolRun by id (sase-17p.4) ([df8ed51](https://github.com/sase-org/sase/commit/df8ed5134112a26735b501c5126593a1d40dd8d7))
* **tool:** wrapper-fidelity process groups, early observe, and orphan reaping ([5950d06](https://github.com/sase-org/sase/commit/5950d069c2c5f58f0f42ae2aafb0a8c2c35c0ec2))
* **triage:** pin owner-matching core and verify owners on live candidates ([013a170](https://github.com/sase-org/sase/commit/013a170720270ac4996122bbdb1026f9468d6042))
* **tui-tags:** warm rebuild of tag surfaces, pager accents, tribe PROMPTS chip ([00badb8](https://github.com/sase-org/sase/commit/00badb84eed26e296bdad946b471ecda2e53892f))
* **tui:** add Node Finder previews ([d62a459](https://github.com/sase-org/sase/commit/d62a459a2d527d663cfd425104add367acee4f7e))
* **tui:** describe the Services tab and service host across TUI surfaces ([3b7cfae](https://github.com/sase-org/sase/commit/3b7cfae6f2446129d00a5fc3036109a0c50a5bd8))
* **tui:** project queue capacity multiplier through agent state, dedup, fleet and loaders ([73c47eb](https://github.com/sase-org/sase/commit/73c47eb84f51e40098a25b53420beeebd4a2398c))
* **tui:** show aggregate ?N unknown-wait indicator on clan rows ([95cb3ab](https://github.com/sase-org/sase/commit/95cb3ab06714a20d738e07fcb3446ddf1442b088))
* **tui:** stash-chip contrast fix with dim-label-only top bar and refreshed goldens ([d9f3cbd](https://github.com/sase-org/sase/commit/d9f3cbd4cc2bf79101ad0f198e29af8f1f88410c))
* **update-progress:** add event protocol, timeline, renderers, and session ([d9a1de8](https://github.com/sase-org/sase/commit/d9a1de8cc03d9c8f0cab1a50d150fc8bc67481cd))
* **update-progress:** fix timeline model, renderers, and session lifecycle ([2f15d0a](https://github.com/sase-org/sase/commit/2f15d0a7269aef13b62365e735a2aa1cda59a772))
* **update:** run mode-switch in live session, transient dry-run timeline, docs ([cc29531](https://github.com/sase-org/sase/commit/cc2953128a4ad317b4dc9f0720f629a678bcfaa6))
* **update:** wire handler fixes for live progress (managed rows, trailing order, interrupts, argv, RunUvFn, docs, tests) ([991e36d](https://github.com/sase-org/sase/commit/991e36d955fec3e8c6e927479af304ce592550d8))
* **update:** wire live-update progress session timeline ([f64bd3a](https://github.com/sase-org/sase/commit/f64bd3ac23c282e3af056ace496b5def2eccf37c))
* **verdict-completion:** explicit no-new intent policy with commit-time recheck, typed refusals and verdict provenance (sase-1ah.6) ([9e8a65a](https://github.com/sase-org/sase/commit/9e8a65ad2a7491680ffbea38ceb011e0f10891e2))
* **visual:** wait for maintenance lock and translate -n to SASE_PYTEST_WORKERS ([890058e](https://github.com/sase-org/sase/commit/890058e80360707212ee0ef5047a99ba0010664e))
* **wait-links:** publish wait_for_beads and project agent awaits bead links (sase-17o.2) ([8d97ef7](https://github.com/sase-org/sase/commit/8d97ef7661de6b7aa42cf979d166606c7ee1d815))
* **workspace:** durable rescue store and non-refusing sidecar eviction ([f42a6f9](https://github.com/sase-org/sase/commit/f42a6f964af6ab0cfaf22dca5115585b92d966c4))
* **workspace:** self-healing checkout preparation for numbered workspaces ([496bd7f](https://github.com/sase-org/sase/commit/496bd7fbda22b867e246bf10d1f378815fb416cd))
* **xprompt:** add Python project tag backend and launch integration ([19895a0](https://github.com/sase-org/sase/commit/19895a01bfe8245fd627bf9a24f9cf6fe8bc6600))
* **xprompt:** add queue capacity multiplier plumbing ([6beedbc](https://github.com/sase-org/sase/commit/6beedbc118b8e06d92fdb9145d847e21aab87065))
* **xprompt:** render project tags in agent panel and prompt editor ([eea59a6](https://github.com/sase-org/sase/commit/eea59a65147a1dcd2d3ae7d91e818e3c463227ec))
* **xprompts:** strengthen split-file constraints ([b2137e8](https://github.com/sase-org/sase/commit/b2137e84c907c2c5bfe4a6055c64ba93abd216b1))
* **xprompt:** TUI prompt editor completion and tag defaults ([ec5b91d](https://github.com/sase-org/sase/commit/ec5b91d8dfe9956c3f738b367452efd7ca4a449c))


### Bug Fixes

* **ace-decks:** preserve pending spread card across re-push and split ([37c8bb2](https://github.com/sase-org/sase/commit/37c8bb26438cf1212fcfe24b44f7817b5c5753dc))
* **ace-runner:** recorded errors beat synthetic fallback; truthful runner output ordering ([1a96a22](https://github.com/sase-org/sase/commit/1a96a22f171c845da339870d6cf054828dbf655f))
* **ace-tui:** apply the Files deck spread probe result (sase-17d.12.1) ([27d03a7](https://github.com/sase-org/sase/commit/27d03a7b7224afca6a9083ea8061b9eecb34d4c9))
* **ace-tui:** keep bead note previews readable in narrow Context cards ([7a5559c](https://github.com/sase-org/sase/commit/7a5559cc737aa1d9b2cb90decf1bdb969855f64b))
* **ace-tui:** keep bead read reasons readable in narrow Context cards ([982209d](https://github.com/sase-org/sase/commit/982209db994c2c9b9c45025e0e1c0b9ac3275b49))
* **ace-tui:** pin project-tag catalog in PNG snapshot fixtures ([848a90a](https://github.com/sase-org/sase/commit/848a90a1ba6550faca8c29b8d9dcde81d4decb65))
* **ace-tui:** repair retry countdown visual test query and golden (sase-17m.5.1.6.5.1) ([ced0b15](https://github.com/sase-org/sase/commit/ced0b15e07e1ace5bc0b11b38edb6ff49b0e7d1e))
* **ace:** epic-launch notifications clear when the launching family is read ([fdbaedc](https://github.com/sase-org/sase/commit/fdbaedcee58e1fbda5274246a86043911fa973e9))
* **ace:** fit notification modal footer to modal width so close and +1 stay visible ([03fff9d](https://github.com/sase-org/sase/commit/03fff9dcbcad9c17e62cbc2217033c6be30a6a18))
* **ace:** land sase-16t with display-name scope toasts and epic test repairs ([813f42a](https://github.com/sase-org/sase/commit/813f42a5356e4f80da0502d8570c10202a9fa874))
* **ace:** land sase-185 detached prompt submit ([10422bd](https://github.com/sase-org/sase/commit/10422bd05fe47a34e8b78ef916db103db7018cfc))
* **ace:** land sase-18g header XPROMPT preview goldens and spacing ([d2c2dd1](https://github.com/sase-org/sase/commit/d2c2dd1429db97bc66928f28ce178ee84be5b73a))
* **ace:** make Agents Enter work before the first notification poll ([1329009](https://github.com/sase-org/sase/commit/13290096779fb308e1a2352e9c2d78fcbf986191))
* **ace:** never lose a pane report, never treat loading as absence ([06909a1](https://github.com/sase-org/sase/commit/06909a1aed0aa7da3a52940ea032a6252494ea7c))
* **ace:** preserve session agent removals ([c88987e](https://github.com/sase-org/sase/commit/c88987e7939f0e0e85ed2794bf3e0a5d16bdf037))
* **ace:** quiet false Services unhealthy toast after update-driven restart ([1523580](https://github.com/sase-org/sase/commit/1523580bc659fd1b74efc742dc8aab7ad9637feb))
* **ace:** retire emptied Agents-tab tribe panels whatever way their nodes leave ([2bf6f3d](https://github.com/sase-org/sase/commit/2bf6f3d8721a50d03bb3e22c73e99f6f46497895))
* Adopt the core fix in the prompt widget (sase-1ag.2) ([e565105](https://github.com/sase-org/sase/commit/e565105721bd0c7bc45701f94acb5dae8475dd67))
* **agent-names:** retain live in-flight registry claims ([9d79a73](https://github.com/sase-org/sase/commit/9d79a73462b0e5287dc4731067d1ff81dbe509ae))
* **agent-names:** scope forced-reuse wipes of session members to their own subtree ([fbee04c](https://github.com/sase-org/sase/commit/fbee04cd1d84e5f28657c5d399c54351a179bcd7))
* **agent-session:** finish sase-17m landing gaps and queue capacity plumbing ([fffdaeb](https://github.com/sase-org/sase/commit/fffdaeb3e84392178f4c7bba0344609e440c859a))
* **agent-session:** finish the sase-17m landing ([22e5414](https://github.com/sase-org/sase/commit/22e5414a9f6c7ac09518506ac0f6290cee105eb8))
* **agents-sync:** commit prompt-archive objects with their prompts (sase-196.1) ([f648e88](https://github.com/sase-org/sase/commit/f648e88e4870bc7024a49d873a1ef08f8382b427))
* **agents-view:** dispatch zoom LLM Calls visibility message and repaint header hint on every picker exit ([b3550b5](https://github.com/sase-org/sase/commit/b3550b56ea3dd109249609dde848040a8a09369d))
* **agents:** collapse Enter on tale-plan family to its single tale gate ([4f1177f](https://github.com/sase-org/sase/commit/4f1177f2c58d07e8100c932903a54bdae6807d03))
* **agents:** resolve workflow children of project-level workflows to parent meta Patch ([4022cfe](https://github.com/sase-org/sase/commit/4022cfe595330e2af2c497868fbd8ef62b156c48))
* **agy:** unblock usage probe stderr reads and require sase-core-rs 0.34.71 ([fa61ece](https://github.com/sase-org/sase/commit/fa61ece5a3621806b843be99affe04ef756444d3))
* **artifacts-query:** match path filters by substring on Plans and provider panes ([fc64284](https://github.com/sase-org/sase/commit/fc642845c942bf52dc99595b4e844cedbeacb767))
* **bead:** land sase-17y relocation-safe epic launches ([7a1438b](https://github.com/sase-org/sase/commit/7a1438b142e1cd5b20f897f27f56aa4c68e6f404))
* **bead:** preflight launch names before bead-store mutations ([29f18be](https://github.com/sase-org/sase/commit/29f18be2b1f619497319c575330f8464bc2b4b6d))
* **beads:** bound publication guard git reads to changed and new streams ([1ba4e80](https://github.com/sase-org/sase/commit/1ba4e80e380fef5083faad30b428cd6d7974c6b4))
* **bead:** skip launch-name preflight for ownerless compatibility callers ([566c96b](https://github.com/sase-org/sase/commit/566c96bcdfb98b9d60621ff66ddaa45a66a5ea01))
* **bead:** type work-cleanup snapshot helpers for mypy ([938d2d8](https://github.com/sase-org/sase/commit/938d2d8fec9052d178bdd12ea478af412422cc65))
* **check:** clear lint stragglers from concurrent landings ([561e4b6](https://github.com/sase-org/sase/commit/561e4b6dd51549f0239dbe9a263d519974bb95b1))
* **check:** clear sase-18j triage lint stragglers ([7840592](https://github.com/sase-org/sase/commit/7840592c5e22e99f91f0c71dd385e3c98ad8eb39))
* **check:** land sase-18f green check and finish the flag-close guard ([c7a7890](https://github.com/sase-org/sase/commit/c7a78904bbbb161391ecef6ba4f2eec85f604e95))
* **check:** resolve the ten deterministic just-check failures on master ([d3002ab](https://github.com/sase-org/sase/commit/d3002aba1ad5bcde49fd6f5b030407a2767df6eb))
* **clans:** land sase-170 tribe clan summaries and durable clan records ([1d04946](https://github.com/sase-org/sase/commit/1d04946e49c76888c1023b444678205214c3c5e6))
* **codex:** recover stranded handoff commands ([6a9bac8](https://github.com/sase-org/sase/commit/6a9bac885fb61920d213dabe246f0b06352428b7))
* **command-line:** avoid panel dismissal deadlocks ([6d9d1b5](https://github.com/sase-org/sase/commit/6d9d1b5a0023d8632cdccfd82beab0fd0f729e98))
* **command-line:** fresh completion caches, cd project resolution, key-receipt probe (sase-17x.13.10.4) ([136a3e9](https://github.com/sase-org/sase/commit/136a3e94885a455fc56d1405beabf71ccc6cb07c))
* **command-line:** history walk reset, fixed menu keys, compact key hints (sase-17x.13.10.3) ([e01d346](https://github.com/sase-org/sase/commit/e01d34651b4a356e463f899649a928f70c38c98e))
* **command-line:** land sase-17x.13.10 gaps: history reset, wall-clock elapsed, deterministic goldens ([31ba8e4](https://github.com/sase-org/sase/commit/31ba8e4ddba4f34996c0cde4228435f0b8acb57a))
* **command-line:** move tip marker write off loop, append restored blocks on UI thread (sase-17x.13.10.5) ([ea25ee2](https://github.com/sase-org/sase/commit/ea25ee2bf78796f9850c8164b71ff863b4162d8c))
* **command-line:** scroll popup window, scope provider footer, honor cache TTLs ([61f88cc](https://github.com/sase-org/sase/commit/61f88ccd695509b23b5547d9c9901641746fb005))
* **core-pin:** tolerate ratchet apply exit 2 so the bot reaches push and PR ([1404010](https://github.com/sase-org/sase/commit/1404010b1e255bdc42711b34202c6f0c2d83a27c))
* **core:** speak the agent-session core contract ([d86bcc3](https://github.com/sase-org/sase/commit/d86bcc3ac219c90562dc1d634e93d4af9f44cafe))
* **dev-update:** bound streaming waits, CRLF lines, and backend step details ([e0ffcfd](https://github.com/sase-org/sase/commit/e0ffcfde81bc681f3942d00cee34e9b9fdec6c35))
* **dispatch:** honor local dismissal in remote-attention reconciler ([54d19be](https://github.com/sase-org/sase/commit/54d19bee61104cd15265ffcb0b2b89855e509a0e))
* **finalizers:** adopt decision-scoped completion seal ([45a2e61](https://github.com/sase-org/sase/commit/45a2e61be9b8d5146f05ff360a24577311aab144))
* **finalizers:** let a check failure reproducing on the clean base tree stop blocking bead close ([d5aa86d](https://github.com/sase-org/sase/commit/d5aa86dfc2b2d431f18957f3be42b22f0fd48737))
* **finalizers:** read live bead status when validating close at submit ([e392000](https://github.com/sase-org/sase/commit/e392000cd11cf33bc02c99559a9e014d33fcc98e))
* **finalizers:** survive bead-store push races and footer-only checkpoint drift ([9676df0](https://github.com/sase-org/sase/commit/9676df028f9e925e7d6ec91dbb48c5c8d77aeb63))
* **finalizer:** tolerate transient bead-sidecar sync dirt during commit finalization ([7cdde2b](https://github.com/sase-org/sase/commit/7cdde2b32aa7e38c3c47a35c27e1fa0e309127ec))
* **fork-waits:** keep session fork waits blocked while a successor is slot-queued ([fdbc47b](https://github.com/sase-org/sase/commit/fdbc47b51aac9a7180c9f7cd2f1c30321f5f7467))
* **gate:** refuse rowless shell-block custom gates and prove the row end to end ([c6807d2](https://github.com/sase-org/sase/commit/c6807d24cb3847ced1af4487637448fa35858f19))
* **gate:** repair Master Gate failures and shrink docs PDF under size gate ([c87c9d1](https://github.com/sase-org/sase/commit/c87c9d1aa9383d0d9bd5431b0339f72270100329))
* ignore cache-only script directories in pyscripts lint ([4b3699f](https://github.com/sase-org/sase/commit/4b3699f0dc3242c723f498c654f643cec5f337d0))
* **lease:** recover stale index.lock on prepare and reset ([7e5b6b8](https://github.com/sase-org/sase/commit/7e5b6b8a880b3a5fdf3c7fdb9de4370628d64aff))
* **lint:** restore every lint gate except toobig (sase-18f.1) ([114fbca](https://github.com/sase-org/sase/commit/114fbca89a9430704d877982b4180a0425763e94))
* **llm-provider:** harden usage probe and refresh-runner robustness ([caca6b6](https://github.com/sase-org/sase/commit/caca6b60f9a2263ea29073be42fee94c1b88c52f))
* **llm:** retry Claude OAuth refresh lock contention ([7512f4e](https://github.com/sase-org/sase/commit/7512f4e9a1695e452d5b7f215a643326ae4bf936))
* **plan:** emit session= coder prompts and settle concurrent gate answers ([11b9c56](https://github.com/sase-org/sase/commit/11b9c56b0d8f5ee36afca4cb11773438a9feb4a1))
* **plan:** land sase-17z name-first plan approve help and wait unblock hint ([3899cb9](https://github.com/sase-org/sase/commit/3899cb92fd66b74b5e23cf609b49e75ae0e683fe))
* **plugins-browser:** land sase-171 agent-CLI install epic ([ba75329](https://github.com/sase-org/sase/commit/ba7532980ba14fec0f47867e19110e3288e74b59))
* **sase-16z.9.1:** land nine review fixes for usage probes and models panel ([4b9da7a](https://github.com/sase-org/sase/commit/4b9da7a334065f6fb1bb138056890c407a9c5f1e))
* **sase-18f.3:** resolve deterministic non-UI check failures ([55936f4](https://github.com/sase-org/sase/commit/55936f429e55d71d411a4c8cfffdb5e13fd64cab))
* **sase-18f.4:** repair ACE TUI tests that fail on clean master ([bf3aa6c](https://github.com/sase-org/sase/commit/bf3aa6c8a39da17fa12c29ef582194a117d9cb83))
* **scheduler:** finish service-host sunset landing leftovers ([da315d7](https://github.com/sase-org/sase/commit/da315d79d16f8a5ec9d2e96a7e59005f83c5d935))
* **sdd:** pull split-beads sidecar clones with layout-aware bead store ([6f48c0c](https://github.com/sase-org/sase/commit/6f48c0cc2e4af701db71fdce25f7d8e51082bfc9))
* **sdd:** trigger sidecar gc on loose-object bytes ([a054efc](https://github.com/sase-org/sase/commit/a054efc585e78078675c9e75bc5ee70fabe21056))
* **service:** land sase-11y.11 and finish the service-host leftovers ([d05be99](https://github.com/sase-org/sase/commit/d05be99aad47548f9973b29042cedef8b6c40cab))
* **service:** reboot-proof service-host GitHub credential and login-session warnings ([ba71aa5](https://github.com/sase-org/sase/commit/ba71aa524f81f2541c40e4d2994f7ea10f876141))
* **service:** refuse detached service host spawns under pytest ([562d52d](https://github.com/sase-org/sase/commit/562d52db043d678e6b53e24609b46659d016d4e7))
* **service:** treat a GitHub deploy-key login as a refused git credential ([8c4acff](https://github.com/sase-org/sase/commit/8c4acffdbae676507fe7343546dbbb44b3a4c320))
* **symvision:** return just symvision to green on master ([0648306](https://github.com/sase-org/sase/commit/0648306324275f38bb1da9f15ef18835d77b4a31))
* **tests:** normalize whitespace in xprompt inline-code wrap assertions ([c77912a](https://github.com/sase-org/sase/commit/c77912a38cf508deb9dc75e1fd3864b0d738fe6f))
* **tool:** emit wire-valid selection evidence for failure triage ([ff5412b](https://github.com/sase-org/sase/commit/ff5412bbb63c676ac995871ee856e190de6afb85))
* **tool:** land sase-16h by moving the core pin past tool_run_observe ([d3fa979](https://github.com/sase-org/sase/commit/d3fa9796823bf547a8117bfd73cdb8ce154e54a1))
* **tool:** land sase-17p E2 hand-off: completion kinds, stale tests, starter attribution ([cae16be](https://github.com/sase-org/sase/commit/cae16be3ca730c7f3201357b00168477fa167ed4))
* **tool:** record runs under the catalog repo identity and stop nested stage events (sase-18j.1) ([290cd1a](https://github.com/sase-org/sase/commit/290cd1aa7c8b646dfefd8e457acc0f9fa5c571aa))
* **tools:** diagnose core-floor bindings across the split sase_core_py module tree ([af6b1f4](https://github.com/sase-org/sase/commit/af6b1f475ca6d4c8a11bad0fd461ec560f0be93b))
* **tools:** show continued run_silent stage failures as failures (sase-191.2) ([245dcb5](https://github.com/sase-org/sase/commit/245dcb55362fca45a0ae4a03d982a059ab38854d))
* **triage:** give the backtest audit table a matching delimiter row (sase-191) ([0f5d897](https://github.com/sase-org/sase/commit/0f5d89750ef60c8fb883a168e45dc38aada36111))
* **triage:** repair backtest audit evidence ([7757bac](https://github.com/sase-org/sase/commit/7757bacc9d82e14a78e1683f0fed407969e98c7c))
* **tui:** avoid app-loop worker hops ([7484c50](https://github.com/sase-org/sase/commit/7484c50abb1bd9c87897d5b0ae4b164da941f242))
* **tui:** guard LLM Calls panel against stale-worker paints; split-key display ([9c701d6](https://github.com/sase-org/sase/commit/9c701d658fef3edcef2981da5c09058ae0844ad1))
* **tui:** pin usage-refresh fallback and proc observer off in PNG snapshot harness ([13467a5](https://github.com/sase-org/sase/commit/13467a570f3d7f4ad839519098ca5e9bde49d671))
* **tui:** scroll spread Ctrl+J onto the titled separator ([59bf17d](https://github.com/sase-org/sase/commit/59bf17d53fa39d9bd31b66cd3375c42b59b1290c))
* **tui:** stop settled verification monitors from counting as failed agents ([3b42cf4](https://github.com/sase-org/sase/commit/3b42cf4716f981380c86decd27424d13ca4d9348))
* **turn-cutover:** repair sase-1ab.2 verification fallout ([c051b9a](https://github.com/sase-org/sase/commit/c051b9a31a3c91c329bb029ea6dcda0ef0ceb0db))
* **visual:** close sase-169 landing gaps in fix-tui-screenshots update mode ([44cc2b7](https://github.com/sase-org/sase/commit/44cc2b74b6c38ce4741d2d1a4822d11bdd0ce3db))
* **wait:** confirm release membership before family handoff ([9bd351b](https://github.com/sase-org/sase/commit/9bd351b677ed6b7375db9807964d08b6396346af))
* **wait:** isolate per-waiter failures in wait_checks and surface runner fallback errors ([7f736de](https://github.com/sase-org/sase/commit/7f736de0d060b89bee33ce8e6320e006795d4978))
* widen dev-extension freshness identity INPUT_PATHS to Cargo.toml, Cargo.lock, rust-toolchain.toml and crates/ ([8d085d0](https://github.com/sase-org/sase/commit/8d085d03c641a4904a06433bca64619e0cd45472))


### Performance Improvements

* **node-finder:** bound snapshot and broad-query filter work (sase-19i.7.1) ([f62604e](https://github.com/sase-org/sase/commit/f62604e712dde4092da845f3c5edce6023f1da96))
* **tui:** defer update/toast/dev-detect imports to cut startup closure to 3246 modules ([dd22887](https://github.com/sase-org/sase/commit/dd22887a1774fa1a6beeebd4f372d74f10b5ff1c))
* **tui:** exact-semantics node-finder snapshot optimizations ([221d72a](https://github.com/sase-org/sase/commit/221d72a13125e1e967305e0c79b5ab9d38b8c653))


### Documentation

* **ace:** rewrite Agents detail docs around decks and cards (sase-17d.11) ([8fd6a05](https://github.com/sase-org/sase/commit/8fd6a054fd899bc40ea2233248a63d09c5b6d4af))
* **agent-session:** match renamed perf scenarios and session copy, fix stale copy-pin tests (sase-17m.5.1.6.4) ([24615e1](https://github.com/sase-org/sase/commit/24615e18d44570c0650fcd597ac2e7f2b8c678e5))
* **agent-session:** rename agent family to agent session across docs and memory (sase-17m.6) ([6960261](https://github.com/sase-org/sase/commit/696026157ee3c66c857ddf3f72a069f5d29c3d72))
* correct refreshed guide claims against current behavior ([95ba80d](https://github.com/sase-org/sase/commit/95ba80d7018a43770e4db281b7af662c8aa3a80b))
* correct refreshed guides against current behavior ([6799f33](https://github.com/sase-org/sase/commit/6799f33d03586af5093b706025a202309655e7e4))
* correct refreshed guides against current behavior ([7ab206f](https://github.com/sase-org/sase/commit/7ab206f09d24a3e878b7a14e0bcc8fe4c0224d41))
* **file-hooks:** update research-highlights example to veto all swarm drafts ([8246e82](https://github.com/sase-org/sase/commit/8246e82868d69dc2dadcb82885fc802afc56f8fe))
* **init:** keep IdentitiesOnly in the shared-config Match guard ([dec493a](https://github.com/sase-org/sase/commit/dec493a814b4686cc0640dacfacab894724b1565))
* **memory:** apply reference-phase corrections for seven backlog beads ([4e0b96e](https://github.com/sase-org/sase/commit/4e0b96e3db5d083822b8fbc422f84ee13e9711ef))
* **memory:** document %queue &lt;M&gt;x capacity multipliers in xprompts ([fa285b2](https://github.com/sase-org/sase/commit/fa285b261f94a7b93b24cb3f7b69b6e0a73ccc42))
* **memory:** linked repos use sase tool run check too ([49bf158](https://github.com/sase-org/sase/commit/49bf158ce6b99362e31ea58d07812fc0cc8d3bf5))
* **memory:** record machine-link and explicit-handoff decisions ([7eceb61](https://github.com/sase-org/sase/commit/7eceb61ad9f37a21713fe9c6e3852e3a6c219e88))
* **memory:** Remove guidance on never using required CLI options ([67fffd8](https://github.com/sase-org/sase/commit/67fffd8ae9316a9d874754d6da3e7e54448622b4))
* point sase-core references at the split module trees from epic sase-15b ([cbc0f0c](https://github.com/sase-org/sase/commit/cbc0f0c32565c5b7da474e00249601344138677e))
* **project-tags:** accuracy pass for tag docs and help ([69ca23a](https://github.com/sase-org/sase/commit/69ca23a2e8ba6046e17589321f403656cdec5f90))
* **project-tags:** present +&lt;project&gt; tags as the default project spelling ([9f9c2b7](https://github.com/sase-org/sase/commit/9f9c2b702733359d4af16f4fdb662df50f9ebdb1))
* refresh guides for agent decks, jump reveals, project tags, and agent-CLI installs ([b4daedd](https://github.com/sase-org/sase/commit/b4daeddfec4c48f393bffac4cbd8f12f009efa72))
* refresh guides for current SASE behavior ([5453acd](https://github.com/sase-org/sase/commit/5453acde0ba981e9efbddd81484ec236d778db8c))
* refresh guides for project tags, service, workspace, and tooling changes ([07d867e](https://github.com/sase-org/sase/commit/07d867e611f12219680f3391b7cee34c6cb6b0d0))
* **sase-11y:** rewrite pre-host leftovers for service-host model ([420d72b](https://github.com/sase-org/sase/commit/420d72bb1d230a8697ec344a24bd0d07a36bb8df))
* **sase-177.4:** up-front monitor routing in skills, memory, and decision text ([7c41709](https://github.com/sase-org/sase/commit/7c41709a7c2925af3845dd61e47d5660208d02a1))
* **scheduler:** rewrite axe/configuration docs around scheduler proc model ([2328b07](https://github.com/sase-org/sase/commit/2328b07ab81702aec7701490781df2b34e72c621))
* **service-host:** rewrite docs around the scheduler/host split ([0ea0f5a](https://github.com/sase-org/sase/commit/0ea0f5a7b3102b717228d32bdd974f870e57b19b))
* **surfaces:** rename AXE tab and AXE restarts to Services tab and scheduler ([d9ae431](https://github.com/sase-org/sase/commit/d9ae431dc719bdfc5e4a686c200c5c02f4f32593))
* **visual:** document fix-tui-screenshots partial-success contract ([4be75a3](https://github.com/sase-org/sase/commit/4be75a3d417deeecd69931a79b9a179c6247dc59))
* **xprompt:** recommend provider_enabled("hard") gating for pinned-model segments ([a5ba3f1](https://github.com/sase-org/sase/commit/a5ba3f1eb0c764e2c4fd307340c38ded0b518437))
...
* **cli:** drop the sase commit alias; stitch create is the only tracked VCS path

### Features

* **ace-tui:** add agents pane with detail view and artifact relations ([2fa772b](https://github.com/sase-org/sase/commit/2fa772b93d3e28c1ffaab259a7b946eac897203f))
* **ace-tui:** show clan/family/lane total runtime rows ([cc66e7b](https://github.com/sase-org/sase/commit/cc66e7bf321680feae3a781a51a1994eb2ef96fa))
* **ace-tui:** show FAMILY SHELLS roster with nested monitor navigation ([104e02e](https://github.com/sase-org/sase/commit/104e02e4748eaa54d2e4e299119067c08d439957))
* **ace:** add artifact links panel ([e8f30d2](https://github.com/sase-org/sase/commit/e8f30d25fba529b2cf16d755fd632915a8f53efe))
* **ace:** add Config sub-tab description rail ([fcbe276](https://github.com/sase-org/sase/commit/fcbe276098ef7028d0dcb3ef55b7aedafb5543a7))
* **ace:** add pane-local artifact query history ([e500f0a](https://github.com/sase-org/sase/commit/e500f0a71ebff2650c8dd4b49e2bdcdd464b5daa))
* **ace:** add Procs filter bar with priority-tab handoff ([3d20654](https://github.com/sase-org/sase/commit/3d2065412ca76bd7fd706655ec91c21c29f59c67))
* **ace:** add read-only link rail ([48e019a](https://github.com/sase-org/sase/commit/48e019af82f279fc51d53d0e1f1ec51123bebd80))
* **ace:** add section jump targets to metadata fold sections ([44ce806](https://github.com/sase-org/sase/commit/44ce8061276bd420e9baa6b447460f5f0da9e3ca))
* **ace:** add Statistics sub-tab description rail ([5205d99](https://github.com/sase-org/sase/commit/5205d99f89b4c32b93659a7803d75d21a9f259f8))
* **ace:** bind m to cycle the Procs monitor filter ([7db3ea9](https://github.com/sase-org/sase/commit/7db3ea954ea0b971ba6db4d6d5d2e4f2fe29c213))
* **ace:** collapse the agent-list status colour ladder ([f24aed1](https://github.com/sase-org/sase/commit/f24aed1dfa6eaad588d456b7f41270a46646ff18))
* **ace:** dismiss finished proc-shell rows from the Agents tab ([f7595ad](https://github.com/sase-org/sase/commit/f7595ad53e21cd26cf630718ce5a5767dac3a5f1))
* **ace:** expose shell forks throughout ACE ([69dc50a](https://github.com/sase-org/sase/commit/69dc50a31af35724d9784b775f557fad3ea0a57f))
* **ace:** fall back to interactive identity for memory panel audit logging ([e5cd318](https://github.com/sase-org/sase/commit/e5cd318b8eef1117b1152f6530908466b2d55ec2))
* **ace:** polish proc shell rows ([e02106a](https://github.com/sase-org/sase/commit/e02106a29f12a8962b75678d4aa84d8f91e4dcb1))
* **ace:** prompt provider drain relaunch after disable ([54ede7f](https://github.com/sase-org/sase/commit/54ede7fa5d078fcdd51ace041b04e5bcfdf530b5))
* **ace:** remove synthetic planner status reconciliation ([de491c7](https://github.com/sase-org/sase/commit/de491c710dda33645f6cdfe7c976e1784d7a5200))
* **ace:** render gate shell rows in agents tui ([10d2c17](https://github.com/sase-org/sase/commit/10d2c17a171ffff1fcf700edadc46be1e4405f2e))
* **ace:** route the Agents-tab v keymap to SasePager under suspend() ([841255d](https://github.com/sase-org/sase/commit/841255df480a0ef7562aacc4a74c730968f103bf))
* **ace:** show clan-wide minimum remaining runtime on collapsed clan lanes ([86bbbb5](https://github.com/sase-org/sase/commit/86bbbb532096a532c61929695b91e9264c5800e9))
* **ace:** show current family shell runtime ([184fa9a](https://github.com/sase-org/sase/commit/184fa9aed8b71a950393c8d1eba67bcee6141766))
* **ace:** surface proc shells in agents tab ([a6a184f](https://github.com/sase-org/sase/commit/a6a184fad0845f0a79e88aeff029a61432443002))
* **ace:** wire Procs filter bar into pane with empty-state and count messaging ([2e0ac0f](https://github.com/sase-org/sase/commit/2e0ac0f37c0dafb6e5ef3afc2c213abae9058d15))
* add /sase_memory_write skill as the memory-edit gate ([80f389d](https://github.com/sase-org/sase/commit/80f389d746baddabe1bb1fc800bce86f3b8dbbd7))
* add ACE memory web browsing ([b3e0cc0](https://github.com/sase-org/sase/commit/b3e0cc0e48d71722e6ec0ffa0525c4127d7cdb0b))
* Add sidecar ref warning log messages ([cbea4f2](https://github.com/sase-org/sase/commit/cbea4f23b2552de812952ec474035d59923a4d2c))
* **agent-catalog:** filter agents by artifact link facets ([ad2032c](https://github.com/sase-org/sase/commit/ad2032c878bc1ee62007a1edf41efc7140a03592))
* **agent-launch:** add typed launch plan facade ([5c9fb7d](https://github.com/sase-org/sase/commit/5c9fb7d07b43c0a72d2f2a74e0adfbe241989cfd))
* **agent-launch:** dispatch stand-alone %proc units natively ([0f00bec](https://github.com/sase-org/sase/commit/0f00becd749b533f850bf4a81d1cccbefe35b792))
* **agent-launch:** evaluate sandboxed %if admission predicates ([13266fd](https://github.com/sase-org/sase/commit/13266fdcaea9f420917478ced04a12d072036246))
* **agent-launch:** keep clan and family identity through typed planning ([abefcc4](https://github.com/sase-org/sase/commit/abefcc4fba5f44198d4375e8ed865b37a81b5c0d))
* **agent-launch:** persist typed launch admission after approval ([383f349](https://github.com/sase-org/sase/commit/383f34956a3f3f0f462429bce7cbffad4d17ff82))
* **agent-scan:** fold monitor_*/gate_* wire fields into nested family_shell at schema v7 ([588a1cf](https://github.com/sase-org/sase/commit/588a1cfaeb86331ce59ec5e649a77682674f2015))
* **agent:** add catalog search command ([85e2f76](https://github.com/sase-org/sase/commit/85e2f768ec6b08d90b937590f8b9230e65624067))
* **agent:** add live TTY panel for sase agent wait ([4f32a6e](https://github.com/sase-org/sase/commit/4f32a6ec75cc2bf14a77b98f4c15fb190741351c))
* **agent:** add provider drain command ([f13361c](https://github.com/sase-org/sase/commit/f13361ca35d7d996580e1d481582ef237ab83202))
* **agent:** add provider-drain planning and execution engine ([bf3206b](https://github.com/sase-org/sase/commit/bf3206b8f02c7f5ced964c93ff8574c2d734b5d4))
* **agent:** add sase agent wait CLI command ([09ec5af](https://github.com/sase-org/sase/commit/09ec5aff1ad0a38710ac48b0de830988db8073e4))
* **agent:** add wait watch engine ([db4aeca](https://github.com/sase-org/sase/commit/db4aecacb8848514825526bf890833f3460c390c))
* **agent:** admit direct ACE and sase run typed proc launches ([1d00fb2](https://github.com/sase-org/sase/commit/1d00fb2c4b67be95784ddb22964b14d315d7a366))
* **agent:** lease workspaces for project conditions ([9cf6049](https://github.com/sase-org/sase/commit/9cf60497818ced2098ef7483302e64ee411b46a7))
* **agent:** make implicit fork waits shell-aware ([2a3e1d2](https://github.com/sase-org/sase/commit/2a3e1d2c658bd6357bd71c8c8b91d4a56c4c65c2))
* **agent:** rebind runner workspace identity ([b7fcee9](https://github.com/sase-org/sase/commit/b7fcee9db595cebb6b5fcbc474898fab8c6595e8))
* **agents:** add bounded viewport loading ([a805b0d](https://github.com/sase-org/sase/commit/a805b0da2f23de59d628c9c16ff4855fb68d8a02))
* **agents:** add Textual-free agent catalog row model ([2a0c7d6](https://github.com/sase-org/sase/commit/2a0c7d6fa8593ab1758117a8ed59cb0a13b5f3b2))
* **agents:** retire q asker suffix ([777e51e](https://github.com/sase-org/sase/commit/777e51e734a6770e232e039ecfa159a199247295))
* **agent:** thread base_env through standalone proc launch runtime ([aeae0bb](https://github.com/sase-org/sase/commit/aeae0bb8f6e63b35b3c31a68f2a0140dd1b14a35))
* **artifact-cli:** add artifact link relation subcommand ([1282c7a](https://github.com/sase-org/sase/commit/1282c7a8c7ff02b328b87bdbe33e28616f9e2020))
* **artifact-links:** add durable truth drift reporting ([58e5a83](https://github.com/sase-org/sase/commit/58e5a8310e26bd823209156c8890ee4fcb2ddfef))
* **artifact-links:** add link subject resolution and follow-link action wiring ([38c1588](https://github.com/sase-org/sase/commit/38c15881ed3047ff976883b56f7e3e17c10f0af5))
* **artifact-links:** add Textual-free derivation module behind a beta flag ([7015c79](https://github.com/sase-org/sase/commit/7015c7938d984037447ed7de29ff952b5aab0650))
* **artifact-links:** consume plan links frontmatter ([b250011](https://github.com/sase-org/sase/commit/b25001124a8bf49f2f0011cecdb417350a720436))
* **artifact-links:** derive links from agent-cited plans in prompt archives ([c7e0a29](https://github.com/sase-org/sase/commit/c7e0a29e50e6914d68b859c9caf25608cb1ec762))
* **artifact-links:** derive links from commits and backfill existing artifacts ([9606947](https://github.com/sase-org/sase/commit/960694738960861c480229edcbd7087767d6f827))
* **artifact-links:** derive plan implements-key and backfill sweep ([e391b1a](https://github.com/sase-org/sase/commit/e391b1a28354166b00437f4ca895eaec81231fe7))
* **artifact-links:** project recomputed edges into the read model (sase-ug.3) ([4bce1a4](https://github.com/sase-org/sase/commit/4bce1a4f68d985c623611416ea8187da7052609f))
* **artifact-refs:** expand artifact link neighborhoods in prompt rendering ([b2a0c68](https://github.com/sase-org/sase/commit/b2a0c68a3ff0e497b007f6455e225fb80ccdb6fd))
* **artifact:** add hard-evidence link suggestions ([7f6f936](https://github.com/sase-org/sase/commit/7f6f936deca3cdb0345292effc2ee3af4b170277))
* **artifact:** preserve typed link relations in ACE ([2730cfe](https://github.com/sase-org/sase/commit/2730cfedca0d162646a69d9d4b1e262ef8cc6a1b))
* **artifacts-agents:** bind j/k navigation on the Agent pane and guard capability reachability ([9b4f7d4](https://github.com/sase-org/sase/commit/9b4f7d41a6d4de19454f1972d1e8f54391723205))
* **artifacts:** add durable read-link outbox ([5d36fef](https://github.com/sase-org/sase/commit/5d36fef263c6f44f7421487056ed5a12db6cc0d3))
* **artifacts:** add the pane description brief ([ceaa377](https://github.com/sase-org/sase/commit/ceaa377fe3d539948edaac34bcb401fe630d658b))
* **artifacts:** load agent pane in two stages ([6ffdfb0](https://github.com/sase-org/sase/commit/6ffdfb0a97a976cdadaccf11c29595d5996d4a8f))
* **artifacts:** put agents first in subtabs ([4dd2995](https://github.com/sase-org/sase/commit/4dd2995028fd6d20b34e1077a7bdc1d8aae9755b))
* **artifacts:** remove agents-pane feature flag and fix stale test fixtures ([e5989fd](https://github.com/sase-org/sase/commit/e5989fd286ed5f2e328e8928c7894028d697285a))
* **artifacts:** resolve pane descriptions ([a792f5d](https://github.com/sase-org/sase/commit/a792f5dc7eef7b937cf2d59f9d286840d392da82))
* **artifacts:** wire agent pane query session ([b85cdff](https://github.com/sase-org/sase/commit/b85cdffd3de6c93b04e9a43c8bf913fed69e2a31))
* **axe,xprompt:** expand disabled-region handling to fork setup, embedded workflows, and VCS tag parsing ([9c7c10a](https://github.com/sase-org/sase/commit/9c7c10aa2a9f73445db7361a6dfaf0e0dbec9877))
* **axe:** project agent family into completion notifications ([67bcea3](https://github.com/sase-org/sase/commit/67bcea32329a897f81eb1b74dcdf5d1b3012fc05))
* **axe:** promote first eligible chop member to clan declarer at dispatch time ([4041c17](https://github.com/sase-org/sase/commit/4041c17e496660326307e422196885ceb795aff7))
* **axe:** route chop proposals through typed admission ([faed143](https://github.com/sase-org/sase/commit/faed143237163b5618384fb60eb9bc16947a36bf))
* **bead-links:** thread link direction and uses count through Python bead link facade ([79e51b5](https://github.com/sase-org/sase/commit/79e51b564ec987540a8a9954603fbd0a5ca2a5ec))
* **bead:** add sase bead note --edit/--remove for note edit and retraction ([868fa81](https://github.com/sase-org/sase/commit/868fa81e1ac8df8de112608b769721b047290abb))
* **bead:** add show epic expansion for `<epic-id>..` batch queries ([9351d79](https://github.com/sase-org/sase/commit/9351d7953cb41250f639a9f32c061627ff0c94a9))
* **bead:** append notes from update ([96151bb](https://github.com/sase-org/sase/commit/96151bbb435c32858e61c8c0d39708d540b22896))
* **bead:** carry structured notes through the Python model and read consumers ([f6c1467](https://github.com/sase-org/sase/commit/f6c14672253185772692f4183e64f07c8df396a8))
* **bead:** page show output and accept multiple ids ([2ed9dc7](https://github.com/sase-org/sase/commit/2ed9dc7c9fbaf640ec79337c2cbdfb0b025bbaad))
* **bead:** route show across enabled projects ([8e32b47](https://github.com/sase-org/sase/commit/8e32b47b36f7e0c9da1d76f7760f57d28d3f69d9))
* **bead:** show provenance-aware artifact-link neighborhood ([a92c0b1](https://github.com/sase-org/sase/commit/a92c0b1c01f9d6a842bb98aeb5967e13c4e5e1e1))
* **beads:** render structured note records ([9488beb](https://github.com/sase-org/sase/commit/9488beb9824ef83157b076f5daf85fed2e31d18d))
* **bead:** support structured note projections ([b74bfa3](https://github.com/sase-org/sase/commit/b74bfa37abe2fd6c466a086949931aeb46680e53))
* **ci:** add fast per-SHA master gate with sharded test matrix ([5d8872f](https://github.com/sase-org/sase/commit/5d8872f4d2ed263d38a41bcedea44fd15e7ba206))
* **ci:** pin the sase-core revision CI builds from ([a8e72ce](https://github.com/sase-org/sase/commit/a8e72cebeb234ff9a7c69483bc4ee800fd6e5ec8))
* **cli:** drop the sase commit alias; stitch create is the only tracked VCS path ([b4a8688](https://github.com/sase-org/sase/commit/b4a86889383e932ff5761dbfdb6ec26752b2b631))
* **completion:** add host %final catalog and ACE argument completion ([f88c9ed](https://github.com/sase-org/sase/commit/f88c9eded9ea9b6395415d27ecd4a9babb5c970c))
* **completion:** expose final directive completions ([f618be6](https://github.com/sase-org/sase/commit/f618be6a809dc0f13a62a2a0e8fba8ac26adc2af))
* Feature flag, pane contract, and the mounted list (sase-tj.4) ([ec2044b](https://github.com/sase-org/sase/commit/ec2044ba9d7ab7a9c937a15c8add25a7ea3c2a65))
* **file-hooks:** add producer-aware file-hook filtering ([740df45](https://github.com/sase-org/sase/commit/740df4518679807b4e8667b71f85d72cbdd0245d))
* **finalizers:** adjudicate typed deferrals at submit time ([524d8f2](https://github.com/sase-org/sase/commit/524d8f26f2b3ff619132248135ef2322349463c5))
* **finalizers:** defer commit on refusal instead of failing the turn ([2b046b1](https://github.com/sase-org/sase/commit/2b046b17460b2e86e24a157c1ba54a97549fd06a))
* **finalizers:** enforce bounded attempts and immutable evidence ([6639a28](https://github.com/sase-org/sase/commit/6639a28016163be274ace52c293bd7aeebfb8470))
* **finalizers:** raise sase-core-rs floor and wire FinalizerDeferralWire ([570b6be](https://github.com/sase-org/sase/commit/570b6be4b0c12eec328e1b8c66ac1440672fd81a))
* **finalizers:** refuse a stitch dispatch protection has already emptied ([fab5f73](https://github.com/sase-org/sase/commit/fab5f731eb32478b32edd4d91f39f2272e541207))
* **finalizers:** seal and authenticate the host-owned execution plan ([9af9e1c](https://github.com/sase-org/sase/commit/9af9e1c3fc6e85abd2b361f121721e35f9676160))
* **finalizers:** seal config snapshot into authority artifact and report live drift as diagnostics ([43f4538](https://github.com/sase-org/sase/commit/43f4538f885e982a082119f5597a63b21b0e98da))
* **final:** publish commit declaration consent model ([4580649](https://github.com/sase-org/sase/commit/45806495fa3905e8d279f1bc504a24a9f02461e2))
* **flags:** polish Config Flags docs, journeys, and chrome goldens ([48f1365](https://github.com/sase-org/sase/commit/48f1365d3ae94ae21226a8e8203a6efdf89a2e3e))
* **gate-shell:** add configurable per-branch follow-up (sase-ud.7) ([72abf37](https://github.com/sase-org/sase/commit/72abf372901571748ba63dc5a88213ac3ba7e875))
* **gate-shell:** add fork classification, CLI list/show/cancel, and shell conformance ([d4c3bb4](https://github.com/sase-org/sase/commit/d4c3bb4083fe11d0b74d3e9ab3fa7ebe0b19e6e1))
* **gate-shell:** migrate /sase_questions to a gate shell behind gate_shell_handoff ([05ce87f](https://github.com/sase-org/sase/commit/05ce87fbf3d0942372ccc3b74cec299f8374af39))
* **gate:** add gate shell lifecycle ([1cb772d](https://github.com/sase-org/sase/commit/1cb772d9c38e648f432460e0a097e78e4ef06df6))
* **gates:** migrate HITL and launch approval to shells ([277099e](https://github.com/sase-org/sase/commit/277099e77516daba6b338faa866dd9b5f0a12d8b))
* **gate:** stream gate-shell command output to gate.log and add answer --detach ([460aa87](https://github.com/sase-org/sase/commit/460aa87863cb8355582c5bc15ecb6679464bd109))
* Generalize fork source resolution and history rendering (sase-t8.1) ([4fb8f3b](https://github.com/sase-org/sase/commit/4fb8f3baee6d17b387f8eda4ee5242be8d936241))
* **git-setup:** adopt the runner's numbered workspace claim ([8426315](https://github.com/sase-org/sase/commit/84263159f6499bf922e33ae58c7b4ce193e6698f))
* **glossary:** add web-memory compat shim and strand mutation engine ([ec889f5](https://github.com/sase-org/sase/commit/ec889f58788ba027631ba901c4be2232b983f5c0))
* **glossary:** emit v2 source wire fields ([af27e67](https://github.com/sase-org/sase/commit/af27e67e06f1e9e185bc08e1581832e4cdd4f743))
* Hold approved epic launches through developer source swaps (sase-s2.2) ([f8a0dd8](https://github.com/sase-org/sase/commit/f8a0dd8585d364db9c0f92fcb676f4f6c951c367))
* Implementation of 202608/group_wait_dependency_indicators.md plan file ([bcffb4a](https://github.com/sase-org/sase/commit/bcffb4a72d68378a03dc387d53eff9ba7a6c30f7))
* **llm:** auto-drain a hard-disabled provider on a usage-limit trip ([d06d268](https://github.com/sase-org/sase/commit/d06d268ea6a49822adbe4bebd81518690c667431))
* Make the top-bar monitor count directly inspectable ([c441385](https://github.com/sase-org/sase/commit/c44138566f907fb2d1116f9293c26b1f010e79de))
* **memory:** add deferred memory read reports ([615b1db](https://github.com/sase-org/sase/commit/615b1db354cf53f957fa546999141788cdad3189))
* **memory:** add glossary web migration command ([f7aa438](https://github.com/sase-org/sase/commit/f7aa438ba77c65f3055eb469905d24ba1b29a449))
* **memory:** add lookup and roster modules for memory web decisions ([2450497](https://github.com/sase-org/sase/commit/2450497bbc17dca97a27b08c4527612e43e0eaac))
* **memory:** add MEMORY FILE header to multi-note selector batch renders ([95dc60c](https://github.com/sase-org/sase/commit/95dc60c5aa2fc1ddf649d3bd46fac6e9c0e75c01))
* **memory:** add memory web substrate ([f72ff9f](https://github.com/sase-org/sase/commit/f72ff9f385643bfe1f7a9b35f72702bd4b055163))
* **memory:** back the glossary catalog with strand-backed sources and fail-closed dual truth ([2b16a06](https://github.com/sase-org/sase/commit/2b16a06483d60ab04cb5dc8cc7ce4966d76c2bac))
* **memory:** delimit batch Markdown section headers ([2069fce](https://github.com/sase-org/sase/commit/2069fcea0b78076ebfbf1cf071bdaecd0d8bc9e3))
* **memory:** generate task_types.md for project roots only ([7690b23](https://github.com/sase-org/sase/commit/7690b23f863bc188992a3202d76e364f5decedc1))
* **memory:** generate task-type strands as a memory web with structured notes ([eb77577](https://github.com/sase-org/sase/commit/eb775777bd4080924c17bb3910583a1c1ed828bb))
* **memory:** make memory read/show variadic over note/web/strand selectors and add the web command group ([cbda792](https://github.com/sase-org/sase/commit/cbda7926f05ffc09eb1c3aaa4693f4fe6a1fbda7))
* **memory:** migrate glossary panel to memory panel and extract keymaps registry ([93d379e](https://github.com/sase-org/sase/commit/93d379e0a66d4299fa429882a244450a47757418))
* **memory:** migrate sase glossary to web ([df95621](https://github.com/sase-org/sase/commit/df956212be2c5c246cb45207c753623b3ca92f5e))
* **memory:** move final-declaration guidance into generated sase.md ([250c012](https://github.com/sase-org/sase/commit/250c0121d4a552f742b938453717e53d6774ad60))
* **memory:** remove memory_webs flag and ship the decisions web ([0adb544](https://github.com/sase-org/sase/commit/0adb544096e9e87001cee9631c98e0a32be6c5d4))
* **memory:** rename memory tiers to core and reference ([c9ca0db](https://github.com/sase-org/sase/commit/c9ca0db5f8d0d7b5d007010e661abb1d2b5638dc))
* **memory:** retire config glossary infrastructure ([cebab38](https://github.com/sase-org/sase/commit/cebab38a1f9b793c59c0671954aab837ab76aee3))
* **memory:** support core memory priority ([c09fe51](https://github.com/sase-org/sase/commit/c09fe5170800136c60ead1934062d1f15fc6dd9e))
* **monitor:** let follow-up agents select a model ([ab5099e](https://github.com/sase-org/sase/commit/ab5099e203990f12cd2c4d44d48394d40fad9349))
* **pager:** add breadcrumb trail navigation ([a6aab3b](https://github.com/sase-org/sase/commit/a6aab3b799a3f64d63135d1645908463f52b1e96))
* **pager:** add link resolution and follow/copy/edit actions ([699037f](https://github.com/sase-org/sase/commit/699037f215b69128b8e49a5ccd7a2c588b002c27))
* **pager:** add prefix-free jump-hint allocator and link scanner ([e877263](https://github.com/sase-org/sase/commit/e877263b65463ef942317df70ab94ba3f168a87c))
* **pager:** add sase pager command ([b52341b](https://github.com/sase-org/sase/commit/b52341b5506a304356a77143a09a986b7fb08683))
* **pager:** add SasePager reading surface ([54f0c2a](https://github.com/sase-org/sase/commit/54f0c2aaa5ebde3bdd2117b82af2a4442c53cf9e))
* **pager:** add structured document adapters ([2e5cd29](https://github.com/sase-org/sase/commit/2e5cd29e680aaa08f57ae9573d11fc93fa9c7025))
* **pager:** align link resolution with rail index ([5fb2189](https://github.com/sase-org/sase/commit/5fb2189c2139663a502af8d6c5d7e3d9feaaead6))
* **pager:** paint link labels ([338ecef](https://github.com/sase-org/sase/commit/338ecef9cbddee88b74818c28d676de9066a38eb))
* **pager:** retire legacy text paging paths ([259f399](https://github.com/sase-org/sase/commit/259f399012febb6778e7ca1bfb94e7251d642b94))
* **plan:** add shell-backed approval handoff ([32da1f3](https://github.com/sase-org/sase/commit/32da1f3d2d76878f61dec184514b7e8620e0b461))
* **plugins:** fall back to git install only on definitive PyPI 404 ([f818f16](https://github.com/sase-org/sase/commit/f818f16a10c6b46e49e0ea8b87d79e7b4d830bd4))
* Procs query profile and row adapter (sase-s9.2) ([ab02603](https://github.com/sase-org/sase/commit/ab0260376c0af00e8b6042c4dc7651145c1b0748))
* project gate shell read metadata ([5a82847](https://github.com/sase-org/sase/commit/5a8284733de96e1aa0665bdcc7d5ac5a82a3be0c))
* Put the Agent pane in the fast-startup inventory and rebaseline and rebase the goldens (sase-tj.10.3) ([e8de34f](https://github.com/sase-org/sase/commit/e8de34fe0c52a13610fd78ae865f982ffde1b4c6))
* **query-profile:** add agents built-in profile ([70a9d10](https://github.com/sase-org/sase/commit/70a9d101583f0610a48ae09fe304c97b6d0ff232))
* **query:** add flat boolean flags and bounds ([dcbf570](https://github.com/sase-org/sase/commit/dcbf570d53a3b8e705955b9729df84672f1abb7c))
* raise sase-core-rs floor to 0.30.0 ([959d559](https://github.com/sase-org/sase/commit/959d55926de21dc2106a65d943fb3e8e268d1f3b))
* raise sase-core-rs floor to 0.31.0 ([d61f3bb](https://github.com/sase-org/sase/commit/d61f3bbc60be5d249ea1474f81bc923bd20afd6d))
* Render shell-aware metadata for agent families ([0155573](https://github.com/sase-org/sase/commit/0155573371843880691ffbadfb15f46bd3a10987))
* Reproduce every failed lane and run exhaustive verification (sase-s1.6) ([5507cc0](https://github.com/sase-org/sase/commit/5507cc069bbebbebaacb78021b65a551f64bc9a7))
* SASE admission regressions and documentation (sase-tk.2) ([9fb3a18](https://github.com/sase-org/sase/commit/9fb3a1805e3cdec51e7d6a42a2340e834f514904))
* **sase:** make beads sidecar lazy-clone by default ([46fc307](https://github.com/sase-org/sase/commit/46fc307d83f7c5d68be943ddde6681079541f37f))
* **shells:** add shells substrate ([e16872c](https://github.com/sase-org/sase/commit/e16872c9deaa9e48cf73e9d26196adf6bae621d8))
* **shells:** pre-allocate VCS workspace on family follow-up launches ([0235ff0](https://github.com/sase-org/sase/commit/0235ff059ad3e5e87156508fd10bf43f7dbcade6))
* **task-types:** neutralize feature refusal copy ([5ca05f6](https://github.com/sase-org/sase/commit/5ca05f6a57a6b4513559e04c62d08c80b3ca7f6b))
* **task-types:** render self-contained memory strands ([6b22f7e](https://github.com/sase-org/sase/commit/6b22f7e72d6d989c7350d3dec1ce41cc9ea0f5f5))
* **test-cost:** commit per-cause cpu_limit budgets with provenance ([22ece6b](https://github.com/sase-org/sase/commit/22ece6b7c1bcc19301b01339e643d88ca647d3cb))
* **tui:** add app-level link trail for Ctrl+O/Ctrl+Shift+O across tabs ([d8e8b5a](https://github.com/sase-org/sase/commit/d8e8b5ab8ed264a983fd892b29d8e6f752428a93))
* **tui:** add link-follow key grammar ([d070280](https://github.com/sase-org/sase/commit/d07028050cb831849d1e666ab267a39223779f9b))
* **tui:** add tooltips to panel tab strip ([23b7abf](https://github.com/sase-org/sase/commit/23b7abf1b2e1817aaa307468209039253baadab6))
* **tui:** color Agents tree guides by hierarchy depth ([9422a5f](https://github.com/sase-org/sase/commit/9422a5f37df8dcfc8092e25fee05602db19059f9))
* **tui:** group notification modal beads by type ([e6eccc5](https://github.com/sase-org/sase/commit/e6eccc5fea6bb4c9b8561267824fbc50753b100b))
* **tui:** hydrate list-shaped artifact records ([a615273](https://github.com/sase-org/sase/commit/a615273b13a5e0615ddbbc6a6c3747c58c19f8f8))
* **tui:** make Admin Center tab memory session-scoped ([a3b69bd](https://github.com/sase-org/sase/commit/a3b69bd85bdbb83c24a457aad126e0891df233f7))
* **tui:** make word completion case-aware ([3837e92](https://github.com/sase-org/sase/commit/3837e92201d02f9e002cacc3a35a5b7345571732))
* **tui:** move links to app-level rail, drop link_rail flag and L bindings ([a7b7028](https://github.com/sase-org/sase/commit/a7b702863fe57552d09ae9cae31f0cbe894959ea))
* **tui:** render agent header proc count as gear badge ([5dc8973](https://github.com/sase-org/sase/commit/5dc8973956dbd2b82635cfb836be712ae9fa8439))
* **tui:** revive agents from artifact pane ([a1e029c](https://github.com/sase-org/sase/commit/a1e029c657392929f52a565946829e2cf5dbbc90))
* **tui:** show community plugin repository owners ([1a652b9](https://github.com/sase-org/sase/commit/1a652b9e64ad7e11bd09537a05f86a4a3c42174c))
* **vcs:** add stitch type filtering ([4612a84](https://github.com/sase-org/sase/commit/4612a84c896e912c021788cc212d2e843e20242c))
* **workspace:** detect multi-workspace pid claims ([6d88905](https://github.com/sase-org/sase/commit/6d889058c89a0318ad74f3eabede360c7580680f))
* **workspace:** skip VCS release on handoff and pid mismatch ([1a14630](https://github.com/sase-org/sase/commit/1a1463028a7619fa7bcd6ad3331ee640ac5f69c5))
* **xprompt:** add gated typed_launch_units fenced-code contract ([316dd82](https://github.com/sase-org/sase/commit/316dd8265f6ba79da9cac3099b19819858acde9e))
* **xprompt:** reference approved plans by path in #coder instead of inlining ([0eb0730](https://github.com/sase-org/sase/commit/0eb073079d2fcc63a0c0ec501364ef99ad770551))
* **xprompt:** surface directive recipe completions ([057e0bb](https://github.com/sase-org/sase/commit/057e0bbacd6170a49c254421a548ab0925978649))


### Bug Fixes

* 202608/code_swap_fd_handoff.md ([50534e4](https://github.com/sase-org/sase/commit/50534e4f8132f30412a6fbc10e846ca8f1dfa1a7))
* **ace-tui:** mount prompt bar immediately and gate relaunch on a cleanup barrier ([1a96ea9](https://github.com/sase-org/sase/commit/1a96ea92bf4dd066e20d51f024fb79001867232d))
* **ace-tui:** render the Link Rail chips and restore AXE folds on back-walk ([00ff34a](https://github.com/sase-org/sase/commit/00ff34acdbb7daffc2863251aac4e1803009c030))
* **ace,history:** finish landing shell forks (sase-t8) ([7be1396](https://github.com/sase-org/sase/commit/7be1396abfc40101f18f58cf6b423398bddf6287))
* **ace:** compact bead wait status tokens ([d864fa9](https://github.com/sase-org/sase/commit/d864fa9493731f4c88338142c1fae0b9674e1c53))
* **ace:** complete the Agents window prefix once after first paint ([45a0a88](https://github.com/sase-org/sase/commit/45a0a8880a4e0c7f55e15ca30959fe8f63b7fde3))
* **ace:** converge completion toast with agent-list done state ([6e8744c](https://github.com/sase-org/sase/commit/6e8744c1013729a53241d6ba86f5318431ed8849))
* **ace:** group stand-alone proc shells under their project ([0c648e0](https://github.com/sase-org/sase/commit/0c648e0337e916cea611e7e2bff92c358d0137fc))
* **ace:** guard stale artifact read hints ([9ea6f04](https://github.com/sase-org/sase/commit/9ea6f043167cd2fed4669922fd9d2c3bf000c738))
* **ace:** join family runtime suffix with a bare slash ([8d8d84e](https://github.com/sase-org/sase/commit/8d8d84e3d8ae04d093bfa90e710d0b1f79d7f5e5))
* **ace:** keep artifact discovery off key path ([795afdc](https://github.com/sase-org/sase/commit/795afdc5faee02e63f5753f3ca7e822797b29538))
* **ace:** keep live ace-run shards in the artifact watcher ([dde1b22](https://github.com/sase-org/sase/commit/dde1b22d843f9a218c950b4141d9d68cca5b3269))
* **ace:** keep pending gate shells visible in the Agents tab ([72a96a8](https://github.com/sase-org/sase/commit/72a96a801dbf8eeb6ee5b1459af94e9626ffb2ed))
* **ace:** keep the prompt editor visible under long completions ([45be84b](https://github.com/sase-org/sase/commit/45be84b24e19e2dd9dbe86fb9139434445e1e6ae))
* **ace:** make family-root kill-and-edit name reuse deterministic ([1b23813](https://github.com/sase-org/sase/commit/1b238136654b2d2cf5b41c2299ab010b17324083))
* **ace:** order family monitor phases after the shell that started them ([0ccfd7a](https://github.com/sase-org/sase/commit/0ccfd7a6ff3c52b163c8a05c1fa3065e1588db97))
* **ace:** prefer latest family plan previews ([e674ffc](https://github.com/sase-org/sase/commit/e674ffc6f2cbced56e60088eaf51c1a08619999c))
* **ace:** preserve proc shell selection on refresh ([6eb51ac](https://github.com/sase-org/sase/commit/6eb51ac49cc08f23ec240f9b73ed059788395a5c))
* **ace:** reflow panel tabs after layout settles ([e856c68](https://github.com/sase-org/sase/commit/e856c68041ecee74e0a33836a86417a6d95d0a88))
* **ace:** retire timestamp reconstruction statuses ([8efce6d](https://github.com/sase-org/sase/commit/8efce6de9d31fa63384767d58606a83f9274ec9e))
* **ace:** stamp finished_at on settled monitor nodes ([965aa5c](https://github.com/sase-org/sase/commit/965aa5c5ec24921f35cc019842a415b94dbc0bdd))
* advance agent marks to folded banners ([04299c2](https://github.com/sase-org/sase/commit/04299c29e7d73cbdb43cb66cf3946521e4873bbc))
* **agent-launch:** preserve rich failure diagnostics ([b8b3a69](https://github.com/sase-org/sase/commit/b8b3a69a74cf6acf2efae8ff5f2c75139a961097))
* **agent-names:** keep render reads off the name-allocation lock ([433ec18](https://github.com/sase-org/sase/commit/433ec186c9b52c7e60ec7b39f88a8bd1a88793a3))
* **agent-names:** pay the full staleness proof on reservation reads ([5a1b886](https://github.com/sase-org/sase/commit/5a1b8868335d8a183e4f6a0fe760efcb8fab9767))
* **agent-search:** let `sase agent search` accept -j/-l/-p after the query ([ba8a9cc](https://github.com/sase-org/sase/commit/ba8a9cc75d0e50442257f01ef9b5a7aec5d9b7b9))
* **agent:** allow forking failed agents ([e4534d2](https://github.com/sase-org/sase/commit/e4534d2651783989fddf66e29a0dc3d562cf0e89))
* **agent:** carry process identity through scan liveness ([612cabf](https://github.com/sase-org/sase/commit/612cabf85a786d9bd2beedbb6556788f6869e70e))
* **agent:** guard runner slots against pid recycling ([7e1214c](https://github.com/sase-org/sase/commit/7e1214ced961376fa623f5115d204c9321c6eb02))
* **agent:** release condition lease on marker failure ([0bdca93](https://github.com/sase-org/sase/commit/0bdca9380de38a8fe7857531537839944bd9f415))
* **agent:** restore logical planner projection rows ([4d31563](https://github.com/sase-org/sase/commit/4d315636322392d692e737651c6d10174ed7d81c))
* **agent:** restore public is_terminal_state in wait_watch ([42b900f](https://github.com/sase-org/sase/commit/42b900fa19de41fcee3bd8473385e46a567352ed))
* **agents:** keep the viewport window inside the Tier 1 contract ([01efe74](https://github.com/sase-org/sase/commit/01efe7424f5dece6f33b8a2bdbd15e0e4028d84b))
* **agents:** preserve planner projection status ([69527b8](https://github.com/sase-org/sase/commit/69527b84a5d139087ff7ae997625ce529812b22c))
* **agents:** ratchet core pin and scope the keypath bench gate ([a5d59a4](https://github.com/sase-org/sase/commit/a5d59a4cb34107399eebcd5bb0bb5d8343b2e8dd))
* **agent:** suppress clean proc admission notifications ([2a13976](https://github.com/sase-org/sase/commit/2a139761e1494703bb087444e219a3f56d829614))
* **artifact-links:** follow sidecar renames ([678988d](https://github.com/sase-org/sase/commit/678988da73439c5c552fcf26a4007f6fcd6a27f6))
* **artifact-links:** make related note migration safe ([012a66a](https://github.com/sase-org/sase/commit/012a66a659853bae9bd27e0c47b0f75178794a80))
* **artifact-links:** preserve aggregate rows across workspace rebuilds ([e46adb7](https://github.com/sase-org/sase/commit/e46adb77f14965dd49d680f35618e1b92b36a1cf))
* **artifact-links:** require fresh deletion authority ([9a477bf](https://github.com/sase-org/sase/commit/9a477bfd1cf8f3aa1fec9e1eae900c9f3cb3970a))
* **artifacts:** preserve captured file-ref suffixes ([a2e9f2e](https://github.com/sase-org/sase/commit/a2e9f2e145b71eecba8f7a39ef1527e8c3ba6cda))
* **attachments:** isolate Pandoc scratch from Git worktrees ([1cc5a23](https://github.com/sase-org/sase/commit/1cc5a239af8693ca16c8899686bb3f9556b68d40))
* **axe:** admit failed-fork parents into a real workspace instead of asserting ([eb1aea8](https://github.com/sase-org/sase/commit/eb1aea8af182c695fb84215ec9c8b121cbc754e2))
* **axe:** emit a structured gate_shell_reclaim chop result ([06a260d](https://github.com/sase-org/sase/commit/06a260d2c07570d48f212b24fc3310adfc39ad67))
* **axe:** preserve chop dispatch project routing ([d88994b](https://github.com/sase-org/sase/commit/d88994bd816dcc61447a068ea4844b3b176b8382))
* **axe:** restore typed chop wait chains ([fdd76b5](https://github.com/sase-org/sase/commit/fdd76b580a2cfe5dd36972540276de9158dd6f00))
* **bead:** preserve legacy conflict event bytes ([8c3ec87](https://github.com/sase-org/sase/commit/8c3ec87f97d35e50cc4b2994ee3c271236a4ca9d))
* **bead:** relaunch lander after closed epic phases ([22a2937](https://github.com/sase-org/sase/commit/22a2937e4a235dab358adb8885f1551114453dad))
* **ci:** ratchet core 0.32.15 and stop GitHub CPU false fails ([6237888](https://github.com/sase-org/sase/commit/6237888953d823c5a382c78e4f1d388b5357c627))
* **ci:** ratchet core 0.32.16 and harden archive-start waits ([25565fc](https://github.com/sase-org/sase/commit/25565fca12325aa6507a6f144b81d9add550ae71))
* **ci:** ratchet core pin and wait for models-panel snapshot refresh ([fa74163](https://github.com/sase-org/sase/commit/fa74163b5a742fa1cd7e8bfcf98fdd5c0b579da3))
* Commit changes left over from '0dx' sase agent ([c8a3c60](https://github.com/sase-org/sase/commit/c8a3c606871efe8cfe86dec918f477e9d05b17d6))
* **commit:** auto-close assigned beads after landing ([f0982f2](https://github.com/sase-org/sase/commit/f0982f28b82bd135db92fc0fd48d8d2aca6ad161))
* **config:** reduce config token refresh churn ([9415b82](https://github.com/sase-org/sase/commit/9415b82af119de673bcc47c9ee19e8464c098d61))
* **dev-update:** migrate past leaked source swap locks ([a519327](https://github.com/sase-org/sase/commit/a5193276bc71e9e432d30853e817cab971b9cb55))
* Duplicate ArtifactsAgentsActionsMixin base class ([fc270fe](https://github.com/sase-org/sase/commit/fc270fe4c956613b2ecc91c8cc8e9bb7e14cab72))
* **fastlane:** repair master gate fast-suite failures ([30f3843](https://github.com/sase-org/sase/commit/30f384324343eb9f2a6f6a84488276c464532ddb))
* **file-hooks:** record dispatch outcomes and repair missed commit batches ([4dde458](https://github.com/sase-org/sase/commit/4dde458f593687ee4e8fb6734c1dbd1b0fef1215))
* **finalizer:** baseline pre-existing checkouts ([222a11e](https://github.com/sase-org/sase/commit/222a11ea0d19603031071abddebd30e44f41435f))
* **finalizers:** accept refusal defer in the public config schema and privatize unused finalizer symbols ([6a91ae8](https://github.com/sase-org/sase/commit/6a91ae88e2d1381105bf86d48c46924701a13e81))
* **finalizers:** attribute run-written paths outside the primary repo ([f67d6e6](https://github.com/sase-org/sase/commit/f67d6e6a44a42afebab52ace729e8f1f22d11e92))
* **finalizers:** canonicalize provider identity and dispatch ([3d66071](https://github.com/sase-org/sase/commit/3d66071d37ce85b736bbf9561f1be0a3dd872478))
* **finalizers:** give declaration recovery an evidence brief of its own run ([6536745](https://github.com/sase-org/sase/commit/65367452b95634556873d1d44ac4373d9bc7a9e3))
* **finalizer:** speak core finalizer wire v2 and decouple the plugin envelope ([7b74525](https://github.com/sase-org/sase/commit/7b74525044362eaee944f3dbe79474dc35eec651))
* **finalizers:** preserve mixed reconciliation declarations ([3712033](https://github.com/sase-org/sase/commit/37120333b0c37a8a1b5c2b5341671cfb70a9d252))
* **finalizers:** prove auto-commits with pre-reconciliation ledger ([cf72b00](https://github.com/sase-org/sase/commit/cf72b00d1885113147072a501473d3ab0eb3829d))
* **finalizers:** prove live e2e acceptance and validate external payloads ([2800900](https://github.com/sase-org/sase/commit/28009002d5da032104d57805a6df293ffeca6b3e))
* **finalizers:** reject stale final declarations ([d8c4085](https://github.com/sase-org/sase/commit/d8c4085524087b768949f2468c0a57376c56f78c))
* **finalizers:** run repair follow-up commits ([a301139](https://github.com/sase-org/sase/commit/a3011392c432bf3232f9cdb1e1337d5aa5222cc5))
* **finalizers:** serialize declaration accept and host-order commits ([c2f46e8](https://github.com/sase-org/sase/commit/c2f46e84e87edcd9994b4b8bde494099652b1941))
* **finalizers:** stop wasting stitch retries and fix a retry-loop hang ([bd26194](https://github.com/sase-org/sase/commit/bd26194672f76c4e5690d0047c70721875c4ab6c))
* **finalizer:** unify baseline ownership reads ([1fe598e](https://github.com/sase-org/sase/commit/1fe598e2d4cf9161d8a7d8e081cbaa0d547d7fbe))
* **gate-shell:** settle subset branch follow-ups ([ba50cee](https://github.com/sase-org/sase/commit/ba50cee2072a80e587fd0d7d2f1e3c3e8d0471e8))
* **gate-shell:** stop the ACE loader reaping pending gate claims ([22f7221](https://github.com/sase-org/sase/commit/22f7221684a6745a3054a977abbf4834e2dc5077))
* **gate:** treat gate handoffs as successful shell handoffs ([6308174](https://github.com/sase-org/sase/commit/630817489aec8f2230109101de4532a3062e70fe))
* **history:** fall back when chat workspace helper is unavailable ([be63e9c](https://github.com/sase-org/sase/commit/be63e9c7dcd35944ac51d7da8171677bbd499205))
* **history:** restore helper-git-cwd chat name fallback ([bcd6813](https://github.com/sase-org/sase/commit/bcd6813d270aa0da6e48df79410fe7017f5441c9))
* **llm:** reserve pooled alias selections at launch ([b59b046](https://github.com/sase-org/sase/commit/b59b0465188a7142566345552a9755c22b2fbe8d))
* Make FinalizerBaselineRecord public ([9c5d26e](https://github.com/sase-org/sase/commit/9c5d26eacf5216d6e1bd3e77f208befaaf4f2bb8))
* Make the commit obligation unambiguous in agent instruction text ([901245c](https://github.com/sase-org/sase/commit/901245cf3e69383541173630c3960a78dfdd156e))
* **memory:** finish retiring the config glossary across ACE and generated memory ([b592cfa](https://github.com/sase-org/sase/commit/b592cfa5760d6f3f8c1b2f948780b0a8e25ae1cf))
* **memory:** repair memory-web landing gaps and config hub tab strip ([6271aa5](https://github.com/sase-org/sase/commit/6271aa52d9a8c952feabd9998b60a15f9fa6a9de))
* **memory:** retire dead glossary symbols ([5fff948](https://github.com/sase-org/sase/commit/5fff948a9735e7f613006a10c8cb34ea8c363d88))
* **memory:** strip roster markers from agent docs ([51bb2f1](https://github.com/sase-org/sase/commit/51bb2f136663f0ebbf9a54a60ee2ffce05bc2294))
* **memory:** wrap the migrated glossary descriptor preamble ([d9341f2](https://github.com/sase-org/sase/commit/d9341f2366a7b1cc16db3a9212aed97c772bf793))
* **monitor:** keep waiters blocked during handoff ([f929b5e](https://github.com/sase-org/sase/commit/f929b5e2c803431399cf0372ab8d50ced906ef6c))
* **notification-gates:** bound cancel_gate lock acquisition with a timeout ([00bb5a0](https://github.com/sase-org/sase/commit/00bb5a0824bc02a0eadadcf9b1aa352ef17cd920))
* **notify:** dispatch tab reads through apply-state-many ([11deaa0](https://github.com/sase-org/sase/commit/11deaa052816777ee25b1cc4eb3923cb77f8d3bd))
* page screen ([01c32d5](https://github.com/sase-org/sase/commit/01c32d51c26bf1707bd84657144bf4739a7b9473))
* **pager:** bound hint capsule styles ([65e0974](https://github.com/sase-org/sase/commit/65e09744a0180e86a21574be01dfc6882d90b969))
* **pager:** render link neighborhoods for pager-followed beads ([5cc5da0](https://github.com/sase-org/sase/commit/5cc5da03a44c56ac25bf3b2971b902aca25a7de2))
* **pipe:** inherit the parent model when a successor has no %model ([c1a5b36](https://github.com/sase-org/sase/commit/c1a5b36f5faf6f014d9d0bddea435a4e9fc4b0ee))
* **plan-shell:** pin gate accents to ladder ([c133ff7](https://github.com/sase-org/sase/commit/c133ff76868f706033770ba7488cfbac869b60b0))
* **plan:** make approved archive handoff workspace-independent ([eae9cf7](https://github.com/sase-org/sase/commit/eae9cf76bedc8d3248a8fb7f1c5d09b0851b1f49))
* **plan:** publish archives before approval responses ([209375b](https://github.com/sase-org/sase/commit/209375b22e8a90f5fa46e2d5e5e4ea5deec7f170))
* **plugins:** batch required-plugin gate installs ([269329d](https://github.com/sase-org/sase/commit/269329d34f0b32cfef8089f168c3e07c9b70dfa1))
* **query:** retire the sase-s9 symvision exemptions and restore is_terminal_state ([2882047](https://github.com/sase-org/sase/commit/2882047e2dfcf63beb7b6132767332b223f00b70))
* **query:** widen boolean value grammar ([aad3d0a](https://github.com/sase-org/sase/commit/aad3d0ab0e5a26c485ff05eb960efec661c24309))
* **release:** allow transitive lock refresh in release metadata ([028d4c8](https://github.com/sase-org/sase/commit/028d4c8715002c42e1c6b4ae9c3d3a77a3145ce9))
* **release:** let Publish ratchet the 0.29.9 core floor ([2647b71](https://github.com/sase-org/sase/commit/2647b717a48d387d45092b3fe27172f598f76aa8))
* **release:** normalize canonical PyPI lock sources ([c718da9](https://github.com/sase-org/sase/commit/c718da9119cf8dccf4a2719a8ce6717991f1ebd1))
* Remove old `FinalizerBaselineRecord = _FinalizerBaselineRecord` line ([d434760](https://github.com/sase-org/sase/commit/d4347600c08962923a23579eb7198e0288ee9532))
* repair the three deterministic master CI failure clusters ([1795085](https://github.com/sase-org/sase/commit/179508566ab85654ec67a340f001fa2a361ab503))
* **sdd:** bound artifact link backfill reconciliation ([cc2d907](https://github.com/sase-org/sase/commit/cc2d90721baf4188eb6e19b116fd594f89ea9bc4))
* **sdd:** converge artifact-link aggregate projections on one read model ([452ac54](https://github.com/sase-org/sase/commit/452ac54cf967dae7f8974eec522dd564007d6545))
* **sdd:** harden remote sidecar cloning ([7707771](https://github.com/sase-org/sase/commit/770777110d19915a93d5861133c660b65e4dcb86))
* **sdd:** render parent plan provenance canonically ([0f3f235](https://github.com/sase-org/sase/commit/0f3f2350d77270935b9bc6142f39df61b50c9ecc))
* **symvision:** repair finalizer setup syntax ([7d956d0](https://github.com/sase-org/sase/commit/7d956d03be392df7ef7d088b5ceb8a8801eeaa0c))
* **task-types:** require one plus-one for bug triage ([70e2d52](https://github.com/sase-org/sase/commit/70e2d5250765cbae1fdb892ee6bc00d7aed20199))
* **tests:** recurate contract manifest budget ([8c1acbf](https://github.com/sase-org/sase/commit/8c1acbfa505626d3e83414018db37349914c885c))
* **time:** resolve UTC-hardcoded display sites and add config.timezone doctor check ([1dd58f0](https://github.com/sase-org/sase/commit/1dd58f06cd52585d90dcafcbb3d92af670e754a7))
* **tui:** align planner projection tests after resume ([9c37645](https://github.com/sase-org/sase/commit/9c37645394bf58b6bb17e44d901f2116ab409d83))
* **tui:** cache prompt panel section visuals ([1858f75](https://github.com/sase-org/sase/commit/1858f75606b82b31087410dc5447ccfcf731759c))
* **tui:** defer confirm dialog default focus ([30b495e](https://github.com/sase-org/sase/commit/30b495e66613e707ac43a7d7641aac869795d9c1))
* **tui:** defer countdown repaint during prompt input ([a01d3e5](https://github.com/sase-org/sase/commit/a01d3e56cb466e47baecf1da507a4b5e8132385e))
* **tui:** exclude gate-shell windows from family and clan runtime ([fbd37ca](https://github.com/sase-org/sase/commit/fbd37ca3da3b262fa310daec15a0fed45489e017))
* **tui:** keep nested agent rows in parent tribe ([17c465c](https://github.com/sase-org/sase/commit/17c465c9d706219323d95e02bc3d8fb7ed09a76f))
* **tui:** make gate shells own decision statuses ([d432798](https://github.com/sase-org/sase/commit/d4327985d50f37797a4782bd98f29ed7bbb9bd99))
* **tui:** move prompt completion lookups off pump ([cff6988](https://github.com/sase-org/sase/commit/cff6988dadfc2a49fc55e34c9a0621afcc7e63f1))
* **tui:** stop settled monitor starters from borrowing monitor runtime ([20f0d13](https://github.com/sase-org/sase/commit/20f0d13959116e67db52269d10f4be0591da6011))
* **tui:** write pump-stall records off the event loop and add index vacuum tooling ([c862ddd](https://github.com/sase-org/sase/commit/c862dddcba39165fe5b21a94e22a5bdf0c3a1bde))
* **wait-deps:** resolve self-family fork waits ([98707c0](https://github.com/sase-org/sase/commit/98707c02b9271e5a01ee2603b60e1d90c35981a0))
* **wait:** resolve gate-shell wait dependencies ([eeb257a](https://github.com/sase-org/sase/commit/eeb257a804538f57d2afad4b7832a1ac26f46675))
* **workspace:** claim git setup workspace under the runner pid ([651619d](https://github.com/sase-org/sase/commit/651619dcb366b8a0ae68e24fbfc8455dd2567f14))
* **xprompt:** bind shorthand text directly from source, not re-lexed ([4d0da0d](https://github.com/sase-org/sase/commit/4d0da0d4be1c0ab5284946c3a6393c3d758a6302))
* **xprompt:** honor text-block terminators in python scanners ([6ca6e79](https://github.com/sase-org/sase/commit/6ca6e798ed2277eab8e1741abc66b2117480f455))
* **xprompt:** narrow +-to-space decoding to bare colon arguments ([ec76ec6](https://github.com/sase-org/sase/commit/ec76ec6ef9e0ea99d1f89a96d2edbaa64372e844))
* **xprompt:** silence swallowed expansion errors and name surplus bindings ([d0ea16e](https://github.com/sase-org/sase/commit/d0ea16ef8eac7043636b4292237d1efc2b92ba9a))
* **xprompt:** stop injecting the VCS workflow tag into #fork-injected history ([6ae021b](https://github.com/sase-org/sase/commit/6ae021b2bb881b928c26cb8c8118ae7f1f1f13ee))


### Performance Improvements

* **ace-tui:** cache provider_source_token and cascade tab cache invalidation ([f49030d](https://github.com/sase-org/sase/commit/f49030db66b134281bc447c9d367cd7aabad6d9c))
* **ace-tui:** reuse parent record markers for workflow step enrichment ([6687426](https://github.com/sase-org/sase/commit/6687426783e2db699ba3fd2ffc8882cc8f435e8f))
* **ace:** cache link subjects per selection ([1e8cd69](https://github.com/sase-org/sase/commit/1e8cd69ef4f639973c61e9dff8fb7fdeef3c7382))
* **agent-names:** memoize registry staleness checks ([fe66394](https://github.com/sase-org/sase/commit/fe663948fa8d495d3eda69d67a7dc7f0ae757f75))
* **beads:** defer external issue refresh ([e234d5d](https://github.com/sase-org/sase/commit/e234d5df9bd3422c6fa099bbd727ee90f54dac1a))
* **ci:** raise Master Gate to eight shards and refresh timings from CI ([69d3d71](https://github.com/sase-org/sase/commit/69d3d71902aec6cbde1dd6d44054d5a1ab166e75))
* **ci:** trim Master Gate fast setup ([a97cabe](https://github.com/sase-org/sase/commit/a97cabe3a2f4dd2186ee3775b85b57244efe3ef6))
* Make the artifact delta the default refresh, not the 2% exception (sase-uv.4) ([794fbd3](https://github.com/sase-org/sase/commit/794fbd3db9f87417599200477ba3a5b149b4f807))
* **plans:** defer plan metadata reads past the inventory slice ([446e9a4](https://github.com/sase-org/sase/commit/446e9a43c359fc8ed943f29ab4eb24c91601dd21))
* **query:** reduce artifact row marshalling ([e394b9d](https://github.com/sase-org/sase/commit/e394b9d9c062ee9b4e226442b201b0c598042890))
* **tui:** index artifact link targets ([4a3cd44](https://github.com/sase-org/sase/commit/4a3cd4404f7cd82814d7ac5baaeaf969c7ad1995))


### Documentation

* **ace,llms:** document provider drain end-to-end and add fakey e2e drain tests ([ad9ed74](https://github.com/sase-org/sase/commit/ad9ed74aff241bc7101a8014210b5acb2e8cefde))
* **ace:** document Procs tab filtering and add filtered PNG snapshot ([37abe19](https://github.com/sase-org/sase/commit/37abe195b91db320983f9a450859d5f3c4b768f0))
* **agent:** document agent wait command ([ab73c84](https://github.com/sase-org/sase/commit/ab73c8498d1ccbaef92391d672e134ced27bd321))
* **agents:** align AGENTS v2 instruction annotations ([2a4c075](https://github.com/sase-org/sase/commit/2a4c075375bc331320fd1b7ad596c5d612274a21))
* **axe:** document typed-admission routing for chop proposals ([30e73cf](https://github.com/sase-org/sase/commit/30e73cfbcaad6caca47d6c49ebd809b650c8a12e))
* **axe:** warn that content-only once_per keys stay reserved ([e2056bd](https://github.com/sase-org/sase/commit/e2056bddebf0898dbf67f8aa8420a057dab42712))
* **beads:** document note --edit/--remove and update --note vs --notes ([f73b56e](https://github.com/sase-org/sase/commit/f73b56e01dc43492e4b7c651c699caad3caec1df))
* **beads:** rewrite bead-notes memory for the append-only note log ([7cb0eab](https://github.com/sase-org/sase/commit/7cb0eab8eca0995f812d8598bcd1337de0d04741))
* correct current behavior reference ([5d1841c](https://github.com/sase-org/sase/commit/5d1841c6f301385f9e8f734f373d7caf4a9d4af5))
* correct provider and typed launch guidance ([ab3233d](https://github.com/sase-org/sase/commit/ab3233d8dc1f0ca3fa88e89248bc84764b633835))
* **finalizers:** document the protection and retry guards ([cddbc1f](https://github.com/sase-org/sase/commit/cddbc1f16777b662416590da4e3a46bf84712214))
* **finalizers:** sync unconditional finalizer contracts ([2f244b7](https://github.com/sase-org/sase/commit/2f244b7c40336ec4d242d2180d96a43907af2728))
* **memory:** add AXE glossary terms ([2e7a723](https://github.com/sase-org/sase/commit/2e7a72354028de5d29d61a68d0a790b0c9d352d8))
* **memory:** add sase-gate glossary strand ([4a987d8](https://github.com/sase-org/sase/commit/4a987d8e8b2afeda8df636d04ceeee50b289a670))
* **memory:** add the Gate Shell glossary strand and gates-never-block decision record ([7bc0c0d](https://github.com/sase-org/sase/commit/7bc0c0d98e4a21870177eb08de23ff129721bacd))
* **memory:** apply AGENTS v2 #a annotation trims ([affc43a](https://github.com/sase-org/sase/commit/affc43a6fef74e33c1c3edfb6cc51b5a978e20af))
* **memory:** apply AGENTS v3 #b repository reminder annotations ([9bc169e](https://github.com/sase-org/sase/commit/9bc169e6cf0ff2ad2e1e31ebd15be4d1c21b80fb))
* **memory:** collapse repository reminders into one IMPORTANT paragraph ([0e47ef6](https://github.com/sase-org/sase/commit/0e47ef6482937cf35ae29529fcb69ba5b840765a))
* **memory:** document the unconditional %final directive ([b351ceb](https://github.com/sase-org/sase/commit/b351ceb33e3b06f294fec1ecea5fd370d8087fc9))
* **memory:** drop stale project/repo glossary aliases, add sase memory alias ([8776211](https://github.com/sase-org/sase/commit/877621113041f1ada918f8f9b0403f388ab2675f))
* **memory:** migrate build_and_run to lint_and_test reference note ([52327ed](https://github.com/sase-org/sase/commit/52327ed785b1a5faec08db9a5bc931b33cb855f1))
* **memory:** refresh Memory Web glossary strands to describe the shipped substrate ([21b49aa](https://github.com/sase-org/sase/commit/21b49aa98a4dd73cd0abc14d4a78fd7cd00f9cce))
* **memory:** retire glossary strand references across docs and skills ([882ba36](https://github.com/sase-org/sase/commit/882ba36f5ae84d3a82230ea2b7ee30f6e8a7d29d))
* **perf:** record artifacts first-paint verification ([f56cf43](https://github.com/sase-org/sase/commit/f56cf433328eea77e9d0a634fa41018cd2d34f58))
* refresh current behavior reference ([d636317](https://github.com/sase-org/sase/commit/d6363171950d371b30c3dfc09c021a177c970b6f))
* refresh current behavior reference ([0f51e8b](https://github.com/sase-org/sase/commit/0f51e8b774a65aee3e1018b7a667389f00bb4221))
* refresh user-facing documentation ([8a26be5](https://github.com/sase-org/sase/commit/8a26be5fb0d9d694e6a1090f6a94869895aec083))
